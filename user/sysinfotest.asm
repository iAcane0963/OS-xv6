...
sinfo(struct sysinfo *info) {
  ...
  20:	abc50513          	addi	a0,a0,-1348 # ad8 <malloc+0xe4>
...
countfree()
{
  ...
  aa:	a4a50513          	addi	a0,a0,-1462 # af0 <malloc+0xfc>
...
testmem() {
 ...
 148:	9e450513          	addi	a0,a0,-1564 # b28 <malloc+0x134>
 ...
 162:	9fa50513          	addi	a0,a0,-1542 # b58 <malloc+0x164>
 ...
 17c:	9b050513          	addi	a0,a0,-1616 # b28 <malloc+0x134>
 ...
 196:	9c650513          	addi	a0,a0,-1594 # b58 <malloc+0x164>
 ...
 1b2:	97a50513          	addi	a0,a0,-1670 # b28 <malloc+0x134>
...
testcall() {
 ...
 1e4:	a7053503          	ld	a0,-1424(a0) # c50 <__SDATA_BEGIN__>
 ...
 202:	96a50513          	addi	a0,a0,-1686 # b68 <malloc+0x174>
 ...
 21c:	96850513          	addi	a0,a0,-1688 # b80 <malloc+0x18c>
...
void testproc() {
 ...
 276:	95e50513          	addi	a0,a0,-1698 # bd0 <malloc+0x1dc>
 ...
 290:	92450513          	addi	a0,a0,-1756 # bb0 <malloc+0x1bc>
 ...
 2e0:	8f450513          	addi	a0,a0,-1804 # bd0 <malloc+0x1dc>
...
main(int argc, char *argv[])
{
 ...
 32a:	8f250513          	addi	a0,a0,-1806 # c18 <malloc+0x224>
...
strcpy(char *s, const char *t)
{
 ...
 344:	0800                	addi	s0,sp,16
  ...
  while((*s++ = *t++) != 0)
 346:	87aa                	mv	a5,a0
 348:	0585                	addi	a1,a1,1 # fffffffffffff001 <__global_pointer$+0xffffffffffffdbb8>
...
gets(char *buf, int max)
{
 ...
 450:	00098023          	sb	zero,0(s3) # 1000 <__BSS_END__+0x390>
  return buf;
}
 454:	855e                	mv	a0,s7
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6a6:	59650513          	addi	a0,a0,1430 # c38 <digits>
 6aa:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 772:	4cab8b93          	addi	s7,s7,1226 # c38 <digits>
 ...
 8b2:	38290913          	addi	s2,s2,898 # c30 <malloc+0x23c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 97a:	2e27b783          	ld	a5,738(a5) # c58 <freep>
 ...
 9a8:	00e6ea63          	bltu	a3,a4,9bc <free+0x50>
{
 ...
 9ea:	26f73923          	sd	a5,626(a4) # c58 <freep>
}
 9ee:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 a1c:	24053503          	ld	a0,576(a0) # c58 <freep>
 ...
 a44:	21890913          	addi	s2,s2,536 # c58 <freep>
  if(p == (char*)-1)
 a48:	5afd                	li	s5,-1
 a4a:	a88d                	j	abc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 a4c:	00000797          	auipc	a5,0x0
 a50:	21478793          	addi	a5,a5,532 # c60 <base>
 a54:	00000717          	auipc	a4,0x0
 a58:	20f73223          	sd	a5,516(a4) # c58 <freep>
 a5c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a7e:	1ca73f23          	sd	a0,478(a4) # c58 <freep>
      return (void*)(p + 1);
 ...
 acc:	b6e080e7          	jalr	-1170(ra) # 636 <sbrk>
  if(p == (char*)-1)
