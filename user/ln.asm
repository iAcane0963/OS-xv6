...
main(int argc, char *argv[])
{
  ...
  14:	80058593          	addi	a1,a1,-2048 # 810 <malloc+0xe6>
  18:	4509                	li	a0,2
  ...
  36:	312080e7          	jalr	786(ra) # 344 <link>
  3a:	00054763          	bltz	a0,48 <main+0x48>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0);
  3e:	4501                	li	a0,0
  40:	00000097          	auipc	ra,0x0
  44:	2a4080e7          	jalr	676(ra) # 2e4 <exit>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  48:	6894                	ld	a3,16(s1)
  4a:	6490                	ld	a2,8(s1)
...
gets(char *buf, int max)
{
 ...
 14e:	1b2080e7          	jalr	434(ra) # 2fc <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1a0:	188080e7          	jalr	392(ra) # 324 <open>
  if(fd < 0)
 ...
 1b0:	190080e7          	jalr	400(ra) # 33c <fstat>
 1b4:	892a                	mv	s2,a0
  close(fd);
 1b6:	8526                	mv	a0,s1
 1b8:	00000097          	auipc	ra,0x0
 1bc:	154080e7          	jalr	340(ra) # 30c <close>
  return r;
}
 1c0:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 2ca:	0800                	addi	s0,sp,16
  ...
  return u->pid;
 2cc:	040007b7          	lui	a5,0x4000
}
 2d0:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffefa4>
 2d2:	07b2                	slli	a5,a5,0xc
 2d4:	4388                	lw	a0,0(a5)
 2d6:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3dc:	47050513          	addi	a0,a0,1136 # 848 <digits>
 3e0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a8:	3a4b8b93          	addi	s7,s7,932 # 848 <digits>
 ...
 5e8:	25c90913          	addi	s2,s2,604 # 840 <malloc+0x116>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b0:	1b47b783          	ld	a5,436(a5) # 860 <freep>
 ...
 6de:	00e6ea63          	bltu	a3,a4,6f2 <free+0x50>
{
 ...
 720:	14f73223          	sd	a5,324(a4) # 860 <freep>
}
 724:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 752:	11253503          	ld	a0,274(a0) # 860 <freep>
 ...
 77a:	0ea90913          	addi	s2,s2,234 # 860 <freep>
  if(p == (char*)-1)
 77e:	5afd                	li	s5,-1
 780:	a88d                	j	7f2 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 782:	00000797          	auipc	a5,0x0
 786:	0e678793          	addi	a5,a5,230 # 868 <base>
 78a:	00000717          	auipc	a4,0x0
 78e:	0cf73b23          	sd	a5,214(a4) # 860 <freep>
 792:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b4:	0aa73823          	sd	a0,176(a4) # 860 <freep>
      return (void*)(p + 1);
 ...
 802:	b6e080e7          	jalr	-1170(ra) # 36c <sbrk>
  if(p == (char*)-1)
