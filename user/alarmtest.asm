...
00000000000000b8 <test0>:
{
  ...
  fa:	2409091b          	addiw	s2,s2,576 # f4240 <__global_pointer$+0xf2d2f>
      write(2, ".", 1);
...
void __attribute__ ((noinline)) foo(int i, int *j) {
 ...
 19a:	5a07879b          	addiw	a5,a5,1440 # 2625a0 <__global_pointer$+0x26108f>
...
0000000000000294 <test2>:
{
 ...
 2e4:	2409091b          	addiw	s2,s2,576 # f4240 <__global_pointer$+0xf2d2f>
        write(2, ".", 1);
