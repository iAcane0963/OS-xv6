...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	2f858593          	addi	a1,a1,760 # 1308 <malloc+0xea>
      18:	4509                	li	a0,2
      1a:	00001097          	auipc	ra,0x1
      1e:	118080e7          	jalr	280(ra) # 1132 <fprintf>
  memset(buf, 0, nbuf);
      22:	864a                	mv	a2,s2
      24:	4581                	li	a1,0
      26:	8526                	mv	a0,s1
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2ba58593          	addi	a1,a1,698 # 1318 <malloc+0xfa>
      66:	4509                	li	a0,2
      68:	00001097          	auipc	ra,0x1
      6c:	0ca080e7          	jalr	202(ra) # 1132 <fprintf>
  exit(1);
      70:	4505                	li	a0,1
      72:	00001097          	auipc	ra,0x1
      76:	d66080e7          	jalr	-666(ra) # dd8 <exit>
...
fork1(void)
{
  ...
  pid = fork();
      ...
      86:	d4e080e7          	jalr	-690(ra) # dd0 <fork>
  if(pid == -1)
      8a:	57fd                	li	a5,-1
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	28850513          	addi	a0,a0,648 # 1320 <malloc+0x102>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	35c70713          	addi	a4,a4,860 # 1420 <malloc+0x202>
    ...
    exit(1);
      ...
      da:	d02080e7          	jalr	-766(ra) # dd8 <exit>
    panic("runcmd");
      de:	00001517          	auipc	a0,0x1
      e2:	24a50513          	addi	a0,a0,586 # 1328 <malloc+0x10a>
    ...
    exec(ecmd->argv[0], ecmd->argv);
      ...
      fa:	d1a080e7          	jalr	-742(ra) # e10 <exec>
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      fe:	6490                	ld	a2,8(s1)
     100:	00001597          	auipc	a1,0x1
     104:	23058593          	addi	a1,a1,560 # 1330 <malloc+0x112>
     108:	4509                	li	a0,2
     10a:	00001097          	auipc	ra,0x1
     10e:	028080e7          	jalr	40(ra) # 1132 <fprintf>
  exit(0);
     112:	4501                	li	a0,0
     114:	00001097          	auipc	ra,0x1
     118:	cc4080e7          	jalr	-828(ra) # dd8 <exit>
      exit(1);
     11c:	4505                	li	a0,1
     11e:	00001097          	auipc	ra,0x1
     122:	cba080e7          	jalr	-838(ra) # dd8 <exit>
    close(rcmd->fd);
     126:	5148                	lw	a0,36(a0)
     128:	00001097          	auipc	ra,0x1
     12c:	cd8080e7          	jalr	-808(ra) # e00 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     130:	508c                	lw	a1,32(s1)
     132:	6888                	ld	a0,16(s1)
     134:	00001097          	auipc	ra,0x1
     138:	ce4080e7          	jalr	-796(ra) # e18 <open>
    ...
    runcmd(rcmd->cmd);
     ...
     150:	1f458593          	addi	a1,a1,500 # 1340 <malloc+0x122>
     154:	4509                	li	a0,2
     156:	00001097          	auipc	ra,0x1
     15a:	fdc080e7          	jalr	-36(ra) # 1132 <fprintf>
      exit(1);
     15e:	4505                	li	a0,1
     160:	00001097          	auipc	ra,0x1
     164:	c78080e7          	jalr	-904(ra) # dd8 <exit>
    if(fork1() == 0)
    ...
    wait(0);
     ...
     178:	c6c080e7          	jalr	-916(ra) # de0 <wait>
    runcmd(lcmd->right);
    ...
    if(pipe(p) < 0)
     ...
     198:	c54080e7          	jalr	-940(ra) # de8 <pipe>
    ...
    close(p[0]);
     ...
     1bc:	c48080e7          	jalr	-952(ra) # e00 <close>
    close(p[1]);
     1c0:	fdc42503          	lw	a0,-36(s0)
     1c4:	00001097          	auipc	ra,0x1
     1c8:	c3c080e7          	jalr	-964(ra) # e00 <close>
    wait(0);
     1cc:	4501                	li	a0,0
     1ce:	00001097          	auipc	ra,0x1
     1d2:	c12080e7          	jalr	-1006(ra) # de0 <wait>
    wait(0);
     1d6:	4501                	li	a0,0
     1d8:	00001097          	auipc	ra,0x1
     1dc:	c08080e7          	jalr	-1016(ra) # de0 <wait>
    break;
     1e0:	bf0d                	j	112 <runcmd+0x6a>
      panic("pipe");
     1e2:	00001517          	auipc	a0,0x1
     1e6:	16e50513          	addi	a0,a0,366 # 1350 <malloc+0x132>
     1ea:	00000097          	auipc	ra,0x0
     1ee:	e6a080e7          	jalr	-406(ra) # 54 <panic>
      close(1);
     1f2:	4505                	li	a0,1
     1f4:	00001097          	auipc	ra,0x1
     1f8:	c0c080e7          	jalr	-1012(ra) # e00 <close>
      dup(p[1]);
     1fc:	fdc42503          	lw	a0,-36(s0)
     200:	00001097          	auipc	ra,0x1
     204:	c50080e7          	jalr	-944(ra) # e50 <dup>
      close(p[0]);
     208:	fd842503          	lw	a0,-40(s0)
     20c:	00001097          	auipc	ra,0x1
     210:	bf4080e7          	jalr	-1036(ra) # e00 <close>
      close(p[1]);
     214:	fdc42503          	lw	a0,-36(s0)
     218:	00001097          	auipc	ra,0x1
     21c:	be8080e7          	jalr	-1048(ra) # e00 <close>
      runcmd(pcmd->left);
     220:	6488                	ld	a0,8(s1)
     ...
     22e:	bd6080e7          	jalr	-1066(ra) # e00 <close>
      dup(p[0]);
     232:	fd842503          	lw	a0,-40(s0)
     236:	00001097          	auipc	ra,0x1
     23a:	c1a080e7          	jalr	-998(ra) # e50 <dup>
      close(p[0]);
     23e:	fd842503          	lw	a0,-40(s0)
     242:	00001097          	auipc	ra,0x1
     246:	bbe080e7          	jalr	-1090(ra) # e00 <close>
      close(p[1]);
     24a:	fdc42503          	lw	a0,-36(s0)
     24e:	00001097          	auipc	ra,0x1
     252:	bb2080e7          	jalr	-1102(ra) # e00 <close>
      runcmd(pcmd->right);
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     288:	f9a080e7          	jalr	-102(ra) # 121e <malloc>
     28c:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d2:	f50080e7          	jalr	-176(ra) # 121e <malloc>
     2d6:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32c:	ef6080e7          	jalr	-266(ra) # 121e <malloc>
     330:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     332:	4661                	li	a2,24
     334:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     372:	eb0080e7          	jalr	-336(ra) # 121e <malloc>
     376:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     378:	4661                	li	a2,24
     37a:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b4:	e6e080e7          	jalr	-402(ra) # 121e <malloc>
     3b8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3ba:	4641                	li	a2,16
     3bc:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	dd6b8b93          	addi	s7,s7,-554 # 1378 <malloc+0x15a>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	da450513          	addi	a0,a0,-604 # 1358 <malloc+0x13a>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	ce460613          	addi	a2,a2,-796 # 1380 <malloc+0x162>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	cd4b0b13          	addi	s6,s6,-812 # 13a0 <malloc+0x182>
  ...
  return ret;
     ...
     70a:	c8250513          	addi	a0,a0,-894 # 1388 <malloc+0x16a>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c2850513          	addi	a0,a0,-984 # 1390 <malloc+0x172>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c0660613          	addi	a2,a2,-1018 # 13a8 <malloc+0x18a>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	b9ea0a13          	addi	s4,s4,-1122 # 13b0 <malloc+0x192>
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	b7060613          	addi	a2,a2,-1168 # 13b8 <malloc+0x19a>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	ad260613          	addi	a2,a2,-1326 # 1380 <malloc+0x162>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	af260613          	addi	a2,a2,-1294 # 13d0 <malloc+0x1b2>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	aa050513          	addi	a0,a0,-1376 # 13c0 <malloc+0x1a2>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	aa850513          	addi	a0,a0,-1368 # 13d8 <malloc+0x1ba>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	adc70713          	addi	a4,a4,-1316 # 1438 <malloc+0x21a>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	90860613          	addi	a2,a2,-1784 # 1310 <malloc+0xf2>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	9b258593          	addi	a1,a1,-1614 # 13f0 <malloc+0x1d2>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	6ea080e7          	jalr	1770(ra) # 1132 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	93850513          	addi	a0,a0,-1736 # 1388 <malloc+0x16a>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	98e48493          	addi	s1,s1,-1650 # 1400 <malloc+0x1e2>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
     a7e:	00000097          	auipc	ra,0x0
     a82:	39a080e7          	jalr	922(ra) # e18 <open>
    ...
    if(fd >= 3){
     ...
     a94:	370080e7          	jalr	880(ra) # e00 <close>
  while(getcmd(buf, sizeof(buf)) >= 0){
     a98:	00001497          	auipc	s1,0x1
     a9c:	9e848493          	addi	s1,s1,-1560 # 1480 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	9dba0a13          	addi	s4,s4,-1573 # 1483 <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	958a8a93          	addi	s5,s5,-1704 # 1408 <malloc+0x1ea>
    ...
    wait(0);
     ...
     aca:	31a080e7          	jalr	794(ra) # de0 <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b1a:	332080e7          	jalr	818(ra) # e48 <chdir>
     ...
     b2c:	60a080e7          	jalr	1546(ra) # 1132 <fprintf>
     b30:	bf79                	j	ace <main+0x6e>
      runcmd(parsecmd(buf));
     b32:	00001517          	auipc	a0,0x1
     b36:	94e50513          	addi	a0,a0,-1714 # 1480 <buf.0>
  ...
  exit(0);
     ...
     b50:	28c080e7          	jalr	652(ra) # dd8 <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c42:	1b2080e7          	jalr	434(ra) # df0 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     c94:	188080e7          	jalr	392(ra) # e18 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     ca4:	190080e7          	jalr	400(ra) # e30 <fstat>
     ca8:	892a                	mv	s2,a0
  close(fd);
     caa:	8526                	mv	a0,s1
     cac:	00000097          	auipc	ra,0x0
     cb0:	154080e7          	jalr	340(ra) # e00 <close>
  return r;
}
     cb4:	854a                	mv	a0,s2
...
ugetpid(void)
{
  ...
  return u->pid;
     dc0:	040007b7          	lui	a5,0x4000
}
     dc4:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffe39c>
     dc6:	07b2                	slli	a5,a5,0xc
     dc8:	4388                	lw	a0,0(a5)
     dca:	6422                	ld	s0,8(sp)
     dcc:	0141                	addi	sp,sp,16
     dce:	8082                	ret

0000000000000dd0 <fork>:
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     e9e:	f5e080e7          	jalr	-162(ra) # df8 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     ebc:	0805c863          	bltz	a1,f4c <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ed0:	58450513          	addi	a0,a0,1412 # 1450 <digits>
     ed4:	883a                	mv	a6,a4
  ...
  if(neg)
     ef8:	00088b63          	beqz	a7,f0e <printint+0x64>
    buf[i++] = '-';
     efc:	fd040793          	addi	a5,s0,-48
     f00:	973e                	add	a4,a4,a5
     f02:	02d00793          	li	a5,45
     f06:	fef70823          	sb	a5,-16(a4)
     f0a:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     f0e:	02e05863          	blez	a4,f3e <printint+0x94>
    ...
    putc(fd, buf[i]);
     ...
     f34:	f58080e7          	jalr	-168(ra) # e88 <putc>
  while(--i >= 0)
     f38:	197d                	addi	s2,s2,-1
     f3a:	ff3918e3          	bne	s2,s3,f2a <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     f84:	02500a13          	li	s4,37
      if(c == 'd'){
     f88:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
     f8c:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
     f90:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
     f94:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     f98:	00000b97          	auipc	s7,0x0
     f9c:	4b8b8b93          	addi	s7,s7,1208 # 1450 <digits>
     fa0:	a839                	j	fbe <vprintf+0x6a>
        putc(fd, c);
     fa2:	85ca                	mv	a1,s2
     fa4:	8556                	mv	a0,s5
     fa6:	00000097          	auipc	ra,0x0
     faa:	ee2080e7          	jalr	-286(ra) # e88 <putc>
     fae:	a019                	j	fb4 <vprintf+0x60>
    } else if(state == '%'){
     fb0:	01498f63          	beq	s3,s4,fce <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     fb4:	0485                	addi	s1,s1,1
     fb6:	fff4c903          	lbu	s2,-1(s1)
     fba:	14090d63          	beqz	s2,1114 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
     fbe:	0009079b          	sext.w	a5,s2
    if(state == 0){
     fc2:	fe0997e3          	bnez	s3,fb0 <vprintf+0x5c>
      if(c == '%'){
     fc6:	fd479ee3          	bne	a5,s4,fa2 <vprintf+0x4e>
        state = '%';
     fca:	89be                	mv	s3,a5
     fcc:	b7e5                	j	fb4 <vprintf+0x60>
      if(c == 'd'){
     fce:	05878063          	beq	a5,s8,100e <vprintf+0xba>
      } else if(c == 'l') {
     fd2:	05978c63          	beq	a5,s9,102a <vprintf+0xd6>
      } else if(c == 'x') {
     fd6:	07a78863          	beq	a5,s10,1046 <vprintf+0xf2>
      } else if(c == 'p') {
     fda:	09b78463          	beq	a5,s11,1062 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
     fde:	07300713          	li	a4,115
     fe2:	0ce78663          	beq	a5,a4,10ae <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     fe6:	06300713          	li	a4,99
     fea:	0ee78e63          	beq	a5,a4,10e6 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
     fee:	11478863          	beq	a5,s4,10fe <vprintf+0x1aa>
        putc(fd, c);
      } else {
     ...
     ffa:	e92080e7          	jalr	-366(ra) # e88 <putc>
        putc(fd, c);
     ffe:	85ca                	mv	a1,s2
    1000:	8556                	mv	a0,s5
    1002:	00000097          	auipc	ra,0x0
    1006:	e86080e7          	jalr	-378(ra) # e88 <putc>
      }
      state = 0;
    100a:	4981                	li	s3,0
    ...
    1020:	e8e080e7          	jalr	-370(ra) # eaa <printint>
    1024:	8b4a                	mv	s6,s2
      state = 0;
    1026:	4981                	li	s3,0
    ...
    103c:	e72080e7          	jalr	-398(ra) # eaa <printint>
    1040:	8b4a                	mv	s6,s2
      state = 0;
    1042:	4981                	li	s3,0
    ...
    1058:	e56080e7          	jalr	-426(ra) # eaa <printint>
    105c:	8b4a                	mv	s6,s2
      state = 0;
    105e:	4981                	li	s3,0
    1060:	bf91                	j	fb4 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    1062:	008b0793          	addi	a5,s6,8
    1066:	f8f43423          	sd	a5,-120(s0)
    106a:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    106e:	03000593          	li	a1,48
    1072:	8556                	mv	a0,s5
    1074:	00000097          	auipc	ra,0x0
    1078:	e14080e7          	jalr	-492(ra) # e88 <putc>
  putc(fd, 'x');
    107c:	85ea                	mv	a1,s10
    107e:	8556                	mv	a0,s5
    1080:	00000097          	auipc	ra,0x0
    1084:	e08080e7          	jalr	-504(ra) # e88 <putc>
    1088:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    109a:	df2080e7          	jalr	-526(ra) # e88 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    109e:	0992                	slli	s3,s3,0x4
    10a0:	397d                	addiw	s2,s2,-1
    10a2:	fe0914e3          	bnez	s2,108a <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    10a6:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10aa:	4981                	li	s3,0
    10ac:	b721                	j	fb4 <vprintf+0x60>
        s = va_arg(ap, char*);
    10ae:	008b0993          	addi	s3,s6,8
    10b2:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    10b6:	02090163          	beqz	s2,10d8 <vprintf+0x184>
        while(*s != 0){
    10ba:	00094583          	lbu	a1,0(s2)
    10be:	c9a1                	beqz	a1,110e <vprintf+0x1ba>
          putc(fd, *s);
    10c0:	8556                	mv	a0,s5
    10c2:	00000097          	auipc	ra,0x0
    10c6:	dc6080e7          	jalr	-570(ra) # e88 <putc>
          s++;
    10ca:	0905                	addi	s2,s2,1
        while(*s != 0){
    10cc:	00094583          	lbu	a1,0(s2)
    10d0:	f9e5                	bnez	a1,10c0 <vprintf+0x16c>
        s = va_arg(ap, char*);
    10d2:	8b4e                	mv	s6,s3
      state = 0;
    10d4:	4981                	li	s3,0
    10d6:	bdf9                	j	fb4 <vprintf+0x60>
          s = "(null)";
    10d8:	00000917          	auipc	s2,0x0
    10dc:	34090913          	addi	s2,s2,832 # 1418 <malloc+0x1fa>
        while(*s != 0){
    10e0:	02800593          	li	a1,40
    10e4:	bff1                	j	10c0 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    10e6:	008b0913          	addi	s2,s6,8
    10ea:	000b4583          	lbu	a1,0(s6)
    10ee:	8556                	mv	a0,s5
    10f0:	00000097          	auipc	ra,0x0
    10f4:	d98080e7          	jalr	-616(ra) # e88 <putc>
    10f8:	8b4a                	mv	s6,s2
      state = 0;
    10fa:	4981                	li	s3,0
    10fc:	bd65                	j	fb4 <vprintf+0x60>
        putc(fd, c);
    10fe:	85d2                	mv	a1,s4
    1100:	8556                	mv	a0,s5
    1102:	00000097          	auipc	ra,0x0
    1106:	d86080e7          	jalr	-634(ra) # e88 <putc>
      state = 0;
    110a:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11a4:	2d87b783          	ld	a5,728(a5) # 1478 <freep>
    11a8:	a805                	j	11d8 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    11aa:	4618                	lw	a4,8(a2)
    11ac:	9db9                	addw	a1,a1,a4
    11ae:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    11b2:	6398                	ld	a4,0(a5)
    11b4:	6318                	ld	a4,0(a4)
    11b6:	fee53823          	sd	a4,-16(a0)
    11ba:	a091                	j	11fe <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    11bc:	ff852703          	lw	a4,-8(a0)
    11c0:	9e39                	addw	a2,a2,a4
    11c2:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    11c4:	ff053703          	ld	a4,-16(a0)
    11c8:	e398                	sd	a4,0(a5)
    11ca:	a099                	j	1210 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11cc:	6398                	ld	a4,0(a5)
    11ce:	00e7e463          	bltu	a5,a4,11d6 <free+0x40>
    11d2:	00e6ea63          	bltu	a3,a4,11e6 <free+0x50>
{
    11d6:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11d8:	fed7fae3          	bgeu	a5,a3,11cc <free+0x36>
    11dc:	6398                	ld	a4,0(a5)
    11de:	00e6e463          	bltu	a3,a4,11e6 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11e2:	fee7eae3          	bltu	a5,a4,11d6 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    11e6:	ff852583          	lw	a1,-8(a0)
    11ea:	6390                	ld	a2,0(a5)
    11ec:	02059713          	slli	a4,a1,0x20
    11f0:	9301                	srli	a4,a4,0x20
    11f2:	0712                	slli	a4,a4,0x4
    11f4:	9736                	add	a4,a4,a3
    11f6:	fae60ae3          	beq	a2,a4,11aa <free+0x14>
    bp->s.ptr = p->s.ptr;
    11fa:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    11fe:	4790                	lw	a2,8(a5)
    1200:	02061713          	slli	a4,a2,0x20
    1204:	9301                	srli	a4,a4,0x20
    1206:	0712                	slli	a4,a4,0x4
    1208:	973e                	add	a4,a4,a5
    120a:	fae689e3          	beq	a3,a4,11bc <free+0x26>
  } else
    p->s.ptr = bp;
    120e:	e394                	sd	a3,0(a5)
  freep = p;
    1210:	00000717          	auipc	a4,0x0
    1214:	26f73423          	sd	a5,616(a4) # 1478 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1242:	00000517          	auipc	a0,0x0
    1246:	23653503          	ld	a0,566(a0) # 1478 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    126a:	00000917          	auipc	s2,0x0
    126e:	20e90913          	addi	s2,s2,526 # 1478 <freep>
  if(p == (char*)-1)
    1272:	5afd                	li	s5,-1
    1274:	a88d                	j	12e6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1276:	00000797          	auipc	a5,0x0
    127a:	27278793          	addi	a5,a5,626 # 14e8 <base>
    127e:	00000717          	auipc	a4,0x0
    1282:	1ef73d23          	sd	a5,506(a4) # 1478 <freep>
    ...
    128c:	b7e1                	j	1254 <malloc+0x36>
      if(p->s.size == nunits)
    128e:	02e48b63          	beq	s1,a4,12c4 <malloc+0xa6>
        p->s.size -= nunits;
    1292:	4137073b          	subw	a4,a4,s3
    1296:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1298:	1702                	slli	a4,a4,0x20
    ...
    12a8:	1ca73a23          	sd	a0,468(a4) # 1478 <freep>
      return (void*)(p + 1);
    ...
    12b4:	74a2                	ld	s1,40(sp)
    12b6:	7902                	ld	s2,32(sp)
    12b8:	69e2                	ld	s3,24(sp)
    12ba:	6a42                	ld	s4,16(sp)
    12bc:	6aa2                	ld	s5,8(sp)
    12be:	6b02                	ld	s6,0(sp)
    12c0:	6121                	addi	sp,sp,64
    12c2:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    12c4:	6398                	ld	a4,0(a5)
    12c6:	e118                	sd	a4,0(a0)
    12c8:	bff1                	j	12a4 <malloc+0x86>
  hp->s.size = nu;
    12ca:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12ce:	0541                	addi	a0,a0,16
    12d0:	00000097          	auipc	ra,0x0
    12d4:	ec6080e7          	jalr	-314(ra) # 1196 <free>
  return freep;
    12d8:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    12dc:	d971                	beqz	a0,12b0 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12de:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12e0:	4798                	lw	a4,8(a5)
    12e2:	fa9776e3          	bgeu	a4,s1,128e <malloc+0x70>
    if(p == freep)
    12e6:	00093703          	ld	a4,0(s2)
    12ea:	853e                	mv	a0,a5
    12ec:	fef719e3          	bne	a4,a5,12de <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    12f0:	8552                	mv	a0,s4
    12f2:	00000097          	auipc	ra,0x0
    12f6:	b6e080e7          	jalr	-1170(ra) # e60 <sbrk>
  if(p == (char*)-1)
    12fa:	fd5518e3          	bne	a0,s5,12ca <malloc+0xac>
        return 0;
    12fe:	4501                	li	a0,0
    1300:	bf45                	j	12b0 <malloc+0x92>
