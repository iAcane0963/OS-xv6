...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	34470713          	addi	a4,a4,836 # 1408 <malloc+0x200>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	ac470713          	addi	a4,a4,-1340 # 1420 <malloc+0x218>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10c6:	33e90913          	addi	s2,s2,830 # 1400 <malloc+0x1f8>
        while(*s != 0){
