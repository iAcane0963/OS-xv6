...
print(const char *s)
{
  ...
  20:	3a6080e7          	jalr	934(ra) # 3c2 <write>
}
  24:	60e2                	ld	ra,24(sp)
  26:	6442                	ld	s0,16(sp)
  28:	64a2                	ld	s1,8(sp)
...
forktest(void)
{
  ...
  3e:	41e50513          	addi	a0,a0,1054 # 458 <pgaccess+0xe>
  ...
  54:	34a080e7          	jalr	842(ra) # 39a <fork>
    if(pid < 0)
  ...
  68:	40450513          	addi	a0,a0,1028 # 468 <pgaccess+0x1e>
  ...
  82:	324080e7          	jalr	804(ra) # 3a2 <exit>
  if(n == N){
  ...
  98:	316080e7          	jalr	790(ra) # 3aa <wait>
  ...
  aa:	304080e7          	jalr	772(ra) # 3aa <wait>
  ae:	57fd                	li	a5,-1
  ...
  b8:	40450513          	addi	a0,a0,1028 # 4b8 <pgaccess+0x6e>
  ...
  d4:	3b850513          	addi	a0,a0,952 # 488 <pgaccess+0x3e>
  ...
  ee:	3b650513          	addi	a0,a0,950 # 4a0 <pgaccess+0x56>
  f2:	00000097          	auipc	ra,0x0
  f6:	f0e080e7          	jalr	-242(ra) # 0 <print>
    exit(1);
  fa:	4505                	li	a0,1
  fc:	00000097          	auipc	ra,0x0
 100:	2a6080e7          	jalr	678(ra) # 3a2 <exit>
...
ugetpid(void)
{
 ...
 38e:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3fff337>
