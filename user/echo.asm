...
main(int argc, char *argv[])
{
  ...
  2e:	80ea0a13          	addi	s4,s4,-2034 # 838 <malloc+0xea>
    write(1, argv[i], strlen(argv[i]));
  ...
  4c:	2e0080e7          	jalr	736(ra) # 328 <write>
    if(i + 1 < argc){
  ...
  60:	2cc080e7          	jalr	716(ra) # 328 <write>
  for(i = 1; i < argc; i++){
  ...
  6c:	7d858593          	addi	a1,a1,2008 # 840 <malloc+0xf2>
  70:	4505                	li	a0,1
  72:	00000097          	auipc	ra,0x0
  76:	2b6080e7          	jalr	694(ra) # 328 <write>
    }
  }
  exit(0);
  7a:	4501                	li	a0,0
  7c:	00000097          	auipc	ra,0x0
  80:	28c080e7          	jalr	652(ra) # 308 <exit>
...
gets(char *buf, int max)
{
 ...
 172:	1b2080e7          	jalr	434(ra) # 320 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1c4:	188080e7          	jalr	392(ra) # 348 <open>
  if(fd < 0)
 ...
 1d4:	190080e7          	jalr	400(ra) # 360 <fstat>
 1d8:	892a                	mv	s2,a0
  close(fd);
 1da:	8526                	mv	a0,s1
 1dc:	00000097          	auipc	ra,0x0
 1e0:	154080e7          	jalr	340(ra) # 330 <close>
  return r;
}
 1e4:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 2ee:	0800                	addi	s0,sp,16
  ...
  return u->pid;
 2f0:	040007b7          	lui	a5,0x4000
}
 2f4:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffef9c>
 2f6:	07b2                	slli	a5,a5,0xc
 2f8:	4388                	lw	a0,0(a5)
 2fa:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 400:	45450513          	addi	a0,a0,1108 # 850 <digits>
 404:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4cc:	388b8b93          	addi	s7,s7,904 # 850 <digits>
 ...
 60c:	24090913          	addi	s2,s2,576 # 848 <malloc+0xfa>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d4:	1987b783          	ld	a5,408(a5) # 868 <freep>
 ...
 702:	00e6ea63          	bltu	a3,a4,716 <free+0x50>
{
 ...
 744:	12f73423          	sd	a5,296(a4) # 868 <freep>
}
 748:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 776:	0f653503          	ld	a0,246(a0) # 868 <freep>
 ...
 79e:	0ce90913          	addi	s2,s2,206 # 868 <freep>
  if(p == (char*)-1)
 7a2:	5afd                	li	s5,-1
 7a4:	a88d                	j	816 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7a6:	00000797          	auipc	a5,0x0
 7aa:	0ca78793          	addi	a5,a5,202 # 870 <base>
 7ae:	00000717          	auipc	a4,0x0
 7b2:	0af73d23          	sd	a5,186(a4) # 868 <freep>
 7b6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d8:	08a73a23          	sd	a0,148(a4) # 868 <freep>
      return (void*)(p + 1);
