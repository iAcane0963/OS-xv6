...
cat(int fd)
{
  ...
  44:	89058593          	addi	a1,a1,-1904 # 8d0 <malloc+0xe8>
  48:	4509                	li	a0,2
  ...
  72:	87a58593          	addi	a1,a1,-1926 # 8e8 <malloc+0x100>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
  ...
  be:	328080e7          	jalr	808(ra) # 3e2 <open>
  c2:	84aa                	mv	s1,a0
  ...
  d6:	2f8080e7          	jalr	760(ra) # 3ca <close>
  for(i = 1; i < argc; i++){
  ...
  e6:	2c0080e7          	jalr	704(ra) # 3a2 <exit>
    cat(0);
  ea:	4501                	li	a0,0
  ...
  fa:	2ac080e7          	jalr	684(ra) # 3a2 <exit>
      fprintf(2, "cat: cannot open %s\n", argv[i]);
  fe:	00093603          	ld	a2,0(s2)
 102:	00000597          	auipc	a1,0x0
 106:	7fe58593          	addi	a1,a1,2046 # 900 <malloc+0x118>
 10a:	4509                	li	a0,2
 ...
 11a:	28c080e7          	jalr	652(ra) # 3a2 <exit>
...
gets(char *buf, int max)
{
 ...
 20c:	1b2080e7          	jalr	434(ra) # 3ba <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 26e:	190080e7          	jalr	400(ra) # 3fa <fstat>
 272:	892a                	mv	s2,a0
  close(fd);
 274:	8526                	mv	a0,s1
...
ugetpid(void)
{
 ...
 388:	0800                	addi	s0,sp,16
  ...
  return u->pid;
 38a:	040007b7          	lui	a5,0x4000
}
 38e:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffeecc>
 390:	07b2                	slli	a5,a5,0xc
 392:	4388                	lw	a0,0(a5)
 394:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49a:	48a50513          	addi	a0,a0,1162 # 920 <digits>
 49e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 566:	3beb8b93          	addi	s7,s7,958 # 920 <digits>
 ...
 6a6:	27690913          	addi	s2,s2,630 # 918 <malloc+0x130>
        while(*s != 0){
...
free(void *ap)
{
 ...
 76e:	1ce7b783          	ld	a5,462(a5) # 938 <freep>
 ...
 79c:	00e6ea63          	bltu	a3,a4,7b0 <free+0x50>
{
 ...
 7de:	14f73f23          	sd	a5,350(a4) # 938 <freep>
}
 7e2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 810:	12c53503          	ld	a0,300(a0) # 938 <freep>
 ...
 838:	10490913          	addi	s2,s2,260 # 938 <freep>
  if(p == (char*)-1)
 83c:	5afd                	li	s5,-1
 83e:	a88d                	j	8b0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 840:	00000797          	auipc	a5,0x0
 844:	30078793          	addi	a5,a5,768 # b40 <base>
 848:	00000717          	auipc	a4,0x0
 84c:	0ef73823          	sd	a5,240(a4) # 938 <freep>
 850:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 872:	0ca73523          	sd	a0,202(a4) # 938 <freep>
      return (void*)(p + 1);
