...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	09a50513          	addi	a0,a0,154 # 60d8 <malloc+0x44a>
      46:	00006097          	auipc	ra,0x6
      4a:	b8a080e7          	jalr	-1142(ra) # 5bd0 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	07850513          	addi	a0,a0,120 # 60f8 <malloc+0x46a>
      88:	00006097          	auipc	ra,0x6
      8c:	b48080e7          	jalr	-1208(ra) # 5bd0 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	06850513          	addi	a0,a0,104 # 6110 <malloc+0x482>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	06a50513          	addi	a0,a0,106 # 6130 <malloc+0x4a2>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	03250513          	addi	a0,a0,50 # 6118 <malloc+0x48a>
      ee:	00006097          	auipc	ra,0x6
      f2:	ae2080e7          	jalr	-1310(ra) # 5bd0 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	03e50513          	addi	a0,a0,62 # 6140 <malloc+0x4b2>
     10a:	00006097          	auipc	ra,0x6
     10e:	ac6080e7          	jalr	-1338(ra) # 5bd0 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	03c50513          	addi	a0,a0,60 # 6168 <malloc+0x4da>
     134:	00005097          	auipc	ra,0x5
     138:	764080e7          	jalr	1892(ra) # 5898 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	02850513          	addi	a0,a0,40 # 6168 <malloc+0x4da>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	02458593          	addi	a1,a1,36 # 6178 <malloc+0x4ea>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	00458593          	addi	a1,a1,4 # 6180 <malloc+0x4f2>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fd450513          	addi	a0,a0,-44 # 6168 <malloc+0x4da>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fbe50513          	addi	a0,a0,-66 # 6188 <malloc+0x4fa>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	9fe080e7          	jalr	-1538(ra) # 5bd0 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	cdc50513          	addi	a0,a0,-804 # 5f58 <malloc+0x2ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	cc8a8a93          	addi	s5,s5,-824 # 5f58 <malloc+0x2ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	e9e50513          	addi	a0,a0,-354 # 61b0 <malloc+0x522>
     31a:	00006097          	auipc	ra,0x6
     31e:	8b6080e7          	jalr	-1866(ra) # 5bd0 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	e9a50513          	addi	a0,a0,-358 # 61d0 <malloc+0x542>
     33e:	00006097          	auipc	ra,0x6
     342:	892080e7          	jalr	-1902(ra) # 5bd0 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	e76a0a13          	addi	s4,s4,-394 # 61e8 <malloc+0x55a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	dd250513          	addi	a0,a0,-558 # 61f0 <malloc+0x562>
     426:	00005097          	auipc	ra,0x5
     42a:	7aa080e7          	jalr	1962(ra) # 5bd0 <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	dcc50513          	addi	a0,a0,-564 # 6208 <malloc+0x57a>
     444:	00005097          	auipc	ra,0x5
     448:	78c080e7          	jalr	1932(ra) # 5bd0 <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	dde50513          	addi	a0,a0,-546 # 6238 <malloc+0x5aa>
     462:	00005097          	auipc	ra,0x5
     466:	76e080e7          	jalr	1902(ra) # 5bd0 <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	df450513          	addi	a0,a0,-524 # 6268 <malloc+0x5da>
     47c:	00005097          	auipc	ra,0x5
     480:	754080e7          	jalr	1876(ra) # 5bd0 <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	de650513          	addi	a0,a0,-538 # 6278 <malloc+0x5ea>
     49a:	00005097          	auipc	ra,0x5
     49e:	736080e7          	jalr	1846(ra) # 5bd0 <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	dd8a0a13          	addi	s4,s4,-552 # 62a8 <malloc+0x61a>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	ca8a8a93          	addi	s5,s5,-856 # 6180 <malloc+0x4f2>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	d3250513          	addi	a0,a0,-718 # 62b0 <malloc+0x622>
     586:	00005097          	auipc	ra,0x5
     58a:	64a080e7          	jalr	1610(ra) # 5bd0 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	d2c50513          	addi	a0,a0,-724 # 62c8 <malloc+0x63a>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	62c080e7          	jalr	1580(ra) # 5bd0 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	cb250513          	addi	a0,a0,-846 # 6268 <malloc+0x5da>
     5be:	00005097          	auipc	ra,0x5
     5c2:	612080e7          	jalr	1554(ra) # 5bd0 <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	d2850513          	addi	a0,a0,-728 # 62f8 <malloc+0x66a>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	5f8080e7          	jalr	1528(ra) # 5bd0 <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	d2250513          	addi	a0,a0,-734 # 6310 <malloc+0x682>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	5da080e7          	jalr	1498(ra) # 5bd0 <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	b3458593          	addi	a1,a1,-1228 # 6178 <malloc+0x4ea>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	b0850513          	addi	a0,a0,-1272 # 6168 <malloc+0x4da>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	adc50513          	addi	a0,a0,-1316 # 6168 <malloc+0x4da>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	ac850513          	addi	a0,a0,-1336 # 6168 <malloc+0x4da>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	cc258593          	addi	a1,a1,-830 # 63a0 <malloc+0x712>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	a4850513          	addi	a0,a0,-1464 # 6168 <malloc+0x4da>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	bdc50513          	addi	a0,a0,-1060 # 6340 <malloc+0x6b2>
     76c:	00005097          	auipc	ra,0x5
     770:	464080e7          	jalr	1124(ra) # 5bd0 <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	be050513          	addi	a0,a0,-1056 # 6360 <malloc+0x6d2>
     788:	00005097          	auipc	ra,0x5
     78c:	448080e7          	jalr	1096(ra) # 5bd0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	bdc50513          	addi	a0,a0,-1060 # 6370 <malloc+0x6e2>
     79c:	00005097          	auipc	ra,0x5
     7a0:	434080e7          	jalr	1076(ra) # 5bd0 <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	be050513          	addi	a0,a0,-1056 # 6390 <malloc+0x702>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	418080e7          	jalr	1048(ra) # 5bd0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	bac50513          	addi	a0,a0,-1108 # 6370 <malloc+0x6e2>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	404080e7          	jalr	1028(ra) # 5bd0 <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	bc650513          	addi	a0,a0,-1082 # 63a8 <malloc+0x71a>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	3e6080e7          	jalr	998(ra) # 5bd0 <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	bc850513          	addi	a0,a0,-1080 # 63c8 <malloc+0x73a>
     808:	00005097          	auipc	ra,0x5
     80c:	3c8080e7          	jalr	968(ra) # 5bd0 <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	bb450513          	addi	a0,a0,-1100 # 63e8 <malloc+0x75a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	bc498993          	addi	s3,s3,-1084 # 6410 <malloc+0x782>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	bf4a8a93          	addi	s5,s5,-1036 # 6448 <malloc+0x7ba>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	b4e50513          	addi	a0,a0,-1202 # 63e8 <malloc+0x75a>
  ...
  if(unlink("small") < 0){
     ...
     8da:	b1250513          	addi	a0,a0,-1262 # 63e8 <malloc+0x75a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	af050513          	addi	a0,a0,-1296 # 63f0 <malloc+0x762>
     908:	00005097          	auipc	ra,0x5
     90c:	2c8080e7          	jalr	712(ra) # 5bd0 <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	b0250513          	addi	a0,a0,-1278 # 6420 <malloc+0x792>
     926:	00005097          	auipc	ra,0x5
     92a:	2aa080e7          	jalr	682(ra) # 5bd0 <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	b1c50513          	addi	a0,a0,-1252 # 6458 <malloc+0x7ca>
     944:	00005097          	auipc	ra,0x5
     948:	28c080e7          	jalr	652(ra) # 5bd0 <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	b2850513          	addi	a0,a0,-1240 # 6480 <malloc+0x7f2>
     960:	00005097          	auipc	ra,0x5
     964:	270080e7          	jalr	624(ra) # 5bd0 <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	b2c50513          	addi	a0,a0,-1236 # 64a0 <malloc+0x812>
     97c:	00005097          	auipc	ra,0x5
     980:	254080e7          	jalr	596(ra) # 5bd0 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	b2850513          	addi	a0,a0,-1240 # 64b8 <malloc+0x82a>
     998:	00005097          	auipc	ra,0x5
     99c:	238080e7          	jalr	568(ra) # 5bd0 <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	b1650513          	addi	a0,a0,-1258 # 64d8 <malloc+0x84a>
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	ac450513          	addi	a0,a0,-1340 # 64d8 <malloc+0x84a>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	a8450513          	addi	a0,a0,-1404 # 64e0 <malloc+0x852>
     a64:	00005097          	auipc	ra,0x5
     a68:	16c080e7          	jalr	364(ra) # 5bd0 <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	a8650513          	addi	a0,a0,-1402 # 6500 <malloc+0x872>
     a82:	00005097          	auipc	ra,0x5
     a86:	14e080e7          	jalr	334(ra) # 5bd0 <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	a9250513          	addi	a0,a0,-1390 # 6528 <malloc+0x89a>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	132080e7          	jalr	306(ra) # 5bd0 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	a1650513          	addi	a0,a0,-1514 # 64d8 <malloc+0x84a>
     ...
     af2:	a5a50513          	addi	a0,a0,-1446 # 6548 <malloc+0x8ba>
     af6:	00005097          	auipc	ra,0x5
     afa:	0da080e7          	jalr	218(ra) # 5bd0 <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	a6450513          	addi	a0,a0,-1436 # 6570 <malloc+0x8e2>
     b14:	00005097          	auipc	ra,0x5
     b18:	0bc080e7          	jalr	188(ra) # 5bd0 <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	a5e50513          	addi	a0,a0,-1442 # 6588 <malloc+0x8fa>
     b32:	00005097          	auipc	ra,0x5
     b36:	09e080e7          	jalr	158(ra) # 5bd0 <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	a6a50513          	addi	a0,a0,-1430 # 65b0 <malloc+0x922>
     b4e:	00005097          	auipc	ra,0x5
     b52:	082080e7          	jalr	130(ra) # 5bd0 <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	37450513          	addi	a0,a0,884 # 5ee8 <malloc+0x25a>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	a5c58593          	addi	a1,a1,-1444 # 65e8 <malloc+0x95a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	34050513          	addi	a0,a0,832 # 5ee8 <malloc+0x25a>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	32a50513          	addi	a0,a0,810 # 5ee8 <malloc+0x25a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	31450513          	addi	a0,a0,788 # 5ee8 <malloc+0x25a>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	a4858593          	addi	a1,a1,-1464 # 6630 <malloc+0x9a2>
  ...
  unlink("unlinkread");
     ...
     c54:	29850513          	addi	a0,a0,664 # 5ee8 <malloc+0x25a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	95850513          	addi	a0,a0,-1704 # 65c8 <malloc+0x93a>
     c78:	00005097          	auipc	ra,0x5
     c7c:	f58080e7          	jalr	-168(ra) # 5bd0 <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	96450513          	addi	a0,a0,-1692 # 65f0 <malloc+0x962>
     c94:	00005097          	auipc	ra,0x5
     c98:	f3c080e7          	jalr	-196(ra) # 5bd0 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	96850513          	addi	a0,a0,-1688 # 6610 <malloc+0x982>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	f20080e7          	jalr	-224(ra) # 5bd0 <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	97450513          	addi	a0,a0,-1676 # 6638 <malloc+0x9aa>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	f04080e7          	jalr	-252(ra) # 5bd0 <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	97850513          	addi	a0,a0,-1672 # 6658 <malloc+0x9ca>
     ce8:	00005097          	auipc	ra,0x5
     cec:	ee8080e7          	jalr	-280(ra) # 5bd0 <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	97c50513          	addi	a0,a0,-1668 # 6678 <malloc+0x9ea>
     d04:	00005097          	auipc	ra,0x5
     d08:	ecc080e7          	jalr	-308(ra) # 5bd0 <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	88858593          	addi	a1,a1,-1912 # 65e8 <malloc+0x95a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	92058593          	addi	a1,a1,-1760 # 66a0 <malloc+0xa12>
     d88:	00006517          	auipc	a0,0x6
     d8c:	91050513          	addi	a0,a0,-1776 # 6698 <malloc+0xa0a>
  ...
  unlink("lf1");
     ...
     da0:	8fc50513          	addi	a0,a0,-1796 # 6698 <malloc+0xa0a>
     da4:	00005097          	auipc	ra,0x5
     da8:	af4080e7          	jalr	-1292(ra) # 5898 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00006517          	auipc	a0,0x6
     db2:	8ea50513          	addi	a0,a0,-1814 # 6698 <malloc+0xa0a>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	8dc50513          	addi	a0,a0,-1828 # 66a0 <malloc+0xa12>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	8a458593          	addi	a1,a1,-1884 # 66a0 <malloc+0xa12>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	88e50513          	addi	a0,a0,-1906 # 66a0 <malloc+0xa12>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	a7e080e7          	jalr	-1410(ra) # 5898 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00006597          	auipc	a1,0x6
     e26:	87658593          	addi	a1,a1,-1930 # 6698 <malloc+0xa0a>
     e2a:	00006517          	auipc	a0,0x6
     e2e:	87650513          	addi	a0,a0,-1930 # 66a0 <malloc+0xa12>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	85a58593          	addi	a1,a1,-1958 # 6698 <malloc+0xa0a>
     e46:	00006517          	auipc	a0,0x6
     e4a:	96250513          	addi	a0,a0,-1694 # 67a8 <malloc+0xb1a>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	84050513          	addi	a0,a0,-1984 # 66a8 <malloc+0xa1a>
     e70:	00005097          	auipc	ra,0x5
     e74:	d60080e7          	jalr	-672(ra) # 5bd0 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	83c50513          	addi	a0,a0,-1988 # 66c0 <malloc+0xa32>
     e8c:	00005097          	auipc	ra,0x5
     e90:	d44080e7          	jalr	-700(ra) # 5bd0 <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	83850513          	addi	a0,a0,-1992 # 66d8 <malloc+0xa4a>
     ea8:	00005097          	auipc	ra,0x5
     eac:	d28080e7          	jalr	-728(ra) # 5bd0 <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	83c50513          	addi	a0,a0,-1988 # 66f8 <malloc+0xa6a>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	d0c080e7          	jalr	-756(ra) # 5bd0 <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	85050513          	addi	a0,a0,-1968 # 6728 <malloc+0xa9a>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	cf0080e7          	jalr	-784(ra) # 5bd0 <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	84c50513          	addi	a0,a0,-1972 # 6740 <malloc+0xab2>
     efc:	00005097          	auipc	ra,0x5
     f00:	cd4080e7          	jalr	-812(ra) # 5bd0 <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	84850513          	addi	a0,a0,-1976 # 6758 <malloc+0xaca>
     f18:	00005097          	auipc	ra,0x5
     f1c:	cb8080e7          	jalr	-840(ra) # 5bd0 <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f30:	85450513          	addi	a0,a0,-1964 # 6780 <malloc+0xaf2>
     f34:	00005097          	auipc	ra,0x5
     f38:	c9c080e7          	jalr	-868(ra) # 5bd0 <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	86850513          	addi	a0,a0,-1944 # 67b0 <malloc+0xb22>
     f50:	00005097          	auipc	ra,0x5
     f54:	c80080e7          	jalr	-896(ra) # 5bd0 <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	822a0a13          	addi	s4,s4,-2014 # 67d0 <malloc+0xb42>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	7d050513          	addi	a0,a0,2000 # 67d0 <malloc+0xb42>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	76850513          	addi	a0,a0,1896 # 67d8 <malloc+0xb4a>
    1078:	00005097          	auipc	ra,0x5
    107c:	b58080e7          	jalr	-1192(ra) # 5bd0 <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	76850513          	addi	a0,a0,1896 # 67f8 <malloc+0xb6a>
    1098:	00005097          	auipc	ra,0x5
    109c:	b38080e7          	jalr	-1224(ra) # 5bd0 <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	76c50513          	addi	a0,a0,1900 # 6818 <malloc+0xb8a>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	b1c080e7          	jalr	-1252(ra) # 5bd0 <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	75a98993          	addi	s3,s3,1882 # 6838 <malloc+0xbaa>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	72e50513          	addi	a0,a0,1838 # 6848 <malloc+0xbba>
    1122:	00005097          	auipc	ra,0x5
    1126:	aae080e7          	jalr	-1362(ra) # 5bd0 <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    118a:	f8a98993          	addi	s3,s3,-118 # 6110 <malloc+0x482>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	82078793          	addi	a5,a5,-2016 # 7a30 <malloc+0x1da2>
  ...
  if(pid == 0){
    ...
    124a:	43a78793          	addi	a5,a5,1082 # 8680 <big.0>
    ...
    1270:	edc78793          	addi	a5,a5,-292 # 8148 <malloc+0x24ba>
    ...
    1294:	e8050513          	addi	a0,a0,-384 # 6110 <malloc+0x482>
    ...
    12ac:	64850513          	addi	a0,a0,1608 # 68f0 <malloc+0xc62>
    12b0:	00005097          	auipc	ra,0x5
    12b4:	920080e7          	jalr	-1760(ra) # 5bd0 <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	5a050513          	addi	a0,a0,1440 # 6868 <malloc+0xbda>
    12d0:	00005097          	auipc	ra,0x5
    12d4:	900080e7          	jalr	-1792(ra) # 5bd0 <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	5a050513          	addi	a0,a0,1440 # 6888 <malloc+0xbfa>
    12f0:	00005097          	auipc	ra,0x5
    12f4:	8e0080e7          	jalr	-1824(ra) # 5bd0 <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	59e50513          	addi	a0,a0,1438 # 68a8 <malloc+0xc1a>
    1312:	00005097          	auipc	ra,0x5
    1316:	8be080e7          	jalr	-1858(ra) # 5bd0 <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	5a650513          	addi	a0,a0,1446 # 68d0 <malloc+0xc42>
    1332:	00005097          	auipc	ra,0x5
    1336:	89e080e7          	jalr	-1890(ra) # 5bd0 <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	a2450513          	addi	a0,a0,-1500 # 6d68 <malloc+0x10da>
    134c:	00005097          	auipc	ra,0x5
    1350:	884080e7          	jalr	-1916(ra) # 5bd0 <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	58a50513          	addi	a0,a0,1418 # 6918 <malloc+0xc8a>
    1396:	00005097          	auipc	ra,0x5
    139a:	83a080e7          	jalr	-1990(ra) # 5bd0 <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	da850513          	addi	a0,a0,-600 # 6168 <malloc+0x4da>
  ...
  if(pid == 0){
    ...
    13ee:	d7ea0a13          	addi	s4,s4,-642 # 6168 <malloc+0x4da>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	586a8a93          	addi	s5,s5,1414 # 6978 <malloc+0xcea>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	4e650513          	addi	a0,a0,1254 # 6948 <malloc+0xcba>
    146a:	00004097          	auipc	ra,0x4
    146e:	766080e7          	jalr	1894(ra) # 5bd0 <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	4e250513          	addi	a0,a0,1250 # 6960 <malloc+0xcd2>
    1486:	00004097          	auipc	ra,0x4
    148a:	74a080e7          	jalr	1866(ra) # 5bd0 <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	4ec50513          	addi	a0,a0,1260 # 6988 <malloc+0xcfa>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	72c080e7          	jalr	1836(ra) # 5bd0 <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	caea0a13          	addi	s4,s4,-850 # 6168 <malloc+0x4da>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	4e6a8a93          	addi	s5,s5,1254 # 69a8 <malloc+0xd1a>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	c5c50513          	addi	a0,a0,-932 # 6168 <malloc+0x4da>
  ...
  exit(xstatus);
    ...
    152e:	43650513          	addi	a0,a0,1078 # 6960 <malloc+0xcd2>
    1532:	00004097          	auipc	ra,0x4
    1536:	69e080e7          	jalr	1694(ra) # 5bd0 <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	46850513          	addi	a0,a0,1128 # 69b0 <malloc+0xd22>
    1550:	00004097          	auipc	ra,0x4
    1554:	680080e7          	jalr	1664(ra) # 5bd0 <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	ba078793          	addi	a5,a5,-1120 # 6110 <malloc+0x482>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	45478793          	addi	a5,a5,1108 # 69d0 <malloc+0xd42>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	44c50513          	addi	a0,a0,1100 # 69d8 <malloc+0xd4a>
  ...
  if(pid == 0) {
    ...
    15be:	41e50513          	addi	a0,a0,1054 # 69d8 <malloc+0xd4a>
    ...
    15da:	42250513          	addi	a0,a0,1058 # 69f8 <malloc+0xd6a>
    15de:	00004097          	auipc	ra,0x4
    15e2:	5f2080e7          	jalr	1522(ra) # 5bd0 <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	35650513          	addi	a0,a0,854 # 6948 <malloc+0xcba>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	5d6080e7          	jalr	1494(ra) # 5bd0 <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	3d250513          	addi	a0,a0,978 # 69e0 <malloc+0xd52>
    1616:	00004097          	auipc	ra,0x4
    161a:	5ba080e7          	jalr	1466(ra) # 5bd0 <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	ae450513          	addi	a0,a0,-1308 # 6110 <malloc+0x482>
  ...
  if(xstatus != 0)
    ...
    1664:	3a850513          	addi	a0,a0,936 # 6a08 <malloc+0xd7a>
    1668:	00004097          	auipc	ra,0x4
    166c:	568080e7          	jalr	1384(ra) # 5bd0 <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	3a450513          	addi	a0,a0,932 # 6a20 <malloc+0xd92>
    1684:	00004097          	auipc	ra,0x4
    1688:	54c080e7          	jalr	1356(ra) # 5bd0 <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	34850513          	addi	a0,a0,840 # 69d8 <malloc+0xd4a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	de650513          	addi	a0,a0,-538 # 64a0 <malloc+0x812>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	50e080e7          	jalr	1294(ra) # 5bd0 <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	28a50513          	addi	a0,a0,650 # 6960 <malloc+0xcd2>
    16de:	00004097          	auipc	ra,0x4
    16e2:	4f2080e7          	jalr	1266(ra) # 5bd0 <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	2e850513          	addi	a0,a0,744 # 69d8 <malloc+0xd4a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	31e50513          	addi	a0,a0,798 # 6a38 <malloc+0xdaa>
    1722:	00004097          	auipc	ra,0x4
    1726:	4ae080e7          	jalr	1198(ra) # 5bd0 <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17e0:	27450513          	addi	a0,a0,628 # 6a50 <malloc+0xdc2>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	3ec080e7          	jalr	1004(ra) # 5bd0 <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	20650513          	addi	a0,a0,518 # 6a68 <malloc+0xdda>
    186a:	00004097          	auipc	ra,0x4
    186e:	366080e7          	jalr	870(ra) # 5bd0 <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	20250513          	addi	a0,a0,514 # 6a80 <malloc+0xdf2>
    1886:	00004097          	auipc	ra,0x4
    188a:	34a080e7          	jalr	842(ra) # 5bd0 <printf>
}
    ...
    18b4:	1e850513          	addi	a0,a0,488 # 6a98 <malloc+0xe0a>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	318080e7          	jalr	792(ra) # 5bd0 <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	1c850513          	addi	a0,a0,456 # 6ab8 <malloc+0xe2a>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	2d8080e7          	jalr	728(ra) # 5bd0 <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	fe650513          	addi	a0,a0,-26 # 6948 <malloc+0xcba>
    196a:	00004097          	auipc	ra,0x4
    196e:	266080e7          	jalr	614(ra) # 5bd0 <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	15250513          	addi	a0,a0,338 # 6ad0 <malloc+0xe42>
    1986:	00004097          	auipc	ra,0x4
    198a:	24a080e7          	jalr	586(ra) # 5bd0 <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	14e50513          	addi	a0,a0,334 # 6ae8 <malloc+0xe5a>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	22e080e7          	jalr	558(ra) # 5bd0 <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	f3650513          	addi	a0,a0,-202 # 6948 <malloc+0xcba>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	1b6080e7          	jalr	438(ra) # 5bd0 <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	f1250513          	addi	a0,a0,-238 # 6948 <malloc+0xcba>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	192080e7          	jalr	402(ra) # 5bd0 <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	05850513          	addi	a0,a0,88 # 6b08 <malloc+0xe7a>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	118080e7          	jalr	280(ra) # 5bd0 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	d86080e7          	jalr	-634(ra) # 5848 <exit>
{
    ...
    1b0c:	01050513          	addi	a0,a0,16 # 6b18 <malloc+0xe8a>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	0c0080e7          	jalr	192(ra) # 5bd0 <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	21250513          	addi	a0,a0,530 # 6d68 <malloc+0x10da>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	072080e7          	jalr	114(ra) # 5bd0 <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	17450513          	addi	a0,a0,372 # 6d68 <malloc+0x10da>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	fd4080e7          	jalr	-44(ra) # 5bd0 <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	dc050513          	addi	a0,a0,-576 # 69e0 <malloc+0xd52>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	fa8080e7          	jalr	-88(ra) # 5bd0 <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	ea650513          	addi	a0,a0,-346 # 6b38 <malloc+0xeaa>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	f36080e7          	jalr	-202(ra) # 5bd0 <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	e8a50513          	addi	a0,a0,-374 # 6b50 <malloc+0xec2>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	f02080e7          	jalr	-254(ra) # 5bd0 <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	e4c50513          	addi	a0,a0,-436 # 6b78 <malloc+0xeea>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	e9c080e7          	jalr	-356(ra) # 5bd0 <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	3b450513          	addi	a0,a0,948 # 6180 <malloc+0x4f2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1dfa:	e6d9899b          	addiw	s3,s3,-403 # 41c64e6d <__BSS_END__+0x41c560c5>
    ...
    1e0c:	378a8a93          	addi	s5,s5,888 # 6180 <malloc+0x4f2>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	d90b8b93          	addi	s7,s7,-624 # 6ba0 <malloc+0xf12>
    1e18:	a825                	j	1e50 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	b2c50513          	addi	a0,a0,-1236 # 6948 <malloc+0xcba>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	dac080e7          	jalr	-596(ra) # 5bd0 <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	e5e50513          	addi	a0,a0,-418 # 6d68 <malloc+0x10da>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	cbe080e7          	jalr	-834(ra) # 5bd0 <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1f4a:	e52b0b13          	addi	s6,s6,-430 # bd98 <buf>
    ...
    1fbe:	bee50513          	addi	a0,a0,-1042 # 6ba8 <malloc+0xf1a>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	c0e080e7          	jalr	-1010(ra) # 5bd0 <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	1f650513          	addi	a0,a0,502 # 61d0 <malloc+0x542>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	bee080e7          	jalr	-1042(ra) # 5bd0 <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	bb050513          	addi	a0,a0,-1104 # 6bd8 <malloc+0xf4a>
    2030:	00004097          	auipc	ra,0x4
    2034:	ba0080e7          	jalr	-1120(ra) # 5bd0 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	b3650513          	addi	a0,a0,-1226 # 6bc0 <malloc+0xf32>
    2092:	00004097          	auipc	ra,0x4
    2096:	b3e080e7          	jalr	-1218(ra) # 5bd0 <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	b5a50513          	addi	a0,a0,-1190 # 6c00 <malloc+0xf72>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	b22080e7          	jalr	-1246(ra) # 5bd0 <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	b5650513          	addi	a0,a0,-1194 # 6c18 <malloc+0xf8a>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	b06080e7          	jalr	-1274(ra) # 5bd0 <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	80650513          	addi	a0,a0,-2042 # 6948 <malloc+0xcba>
    214a:	00004097          	auipc	ra,0x4
    214e:	a86080e7          	jalr	-1402(ra) # 5bd0 <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	acc50513          	addi	a0,a0,-1332 # 6c30 <malloc+0xfa2>
    216c:	00004097          	auipc	ra,0x4
    2170:	a64080e7          	jalr	-1436(ra) # 5bd0 <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ea:	76250513          	addi	a0,a0,1890 # 6948 <malloc+0xcba>
    21ee:	00004097          	auipc	ra,0x4
    21f2:	9e2080e7          	jalr	-1566(ra) # 5bd0 <printf>
      exit(1);
    21f6:	4505                	li	a0,1
    ...
    2216:	a3e50513          	addi	a0,a0,-1474 # 6c50 <malloc+0xfc2>
    221a:	00004097          	auipc	ra,0x4
    221e:	9b6080e7          	jalr	-1610(ra) # 5bd0 <printf>
      exit(1);
    2222:	4505                	li	a0,1
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2246:	a2650513          	addi	a0,a0,-1498 # 6c68 <malloc+0xfda>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2278:	9f450513          	addi	a0,a0,-1548 # 6c68 <malloc+0xfda>
  ...
  close(fd);
    ...
    229e:	2e678793          	addi	a5,a5,742 # 8580 <args.1>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3d668693          	addi	a3,a3,982 # 8678 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22aa:	00005717          	auipc	a4,0x5
    22ae:	9ce70713          	addi	a4,a4,-1586 # 6c78 <malloc+0xfea>
    ...
    2302:	a5a50513          	addi	a0,a0,-1446 # 6d58 <malloc+0x10ca>
    2306:	00004097          	auipc	ra,0x4
    230a:	8ca080e7          	jalr	-1846(ra) # 5bd0 <printf>
    exit(1);
    230e:	4505                	li	a0,1
    ...
    2326:	a5650513          	addi	a0,a0,-1450 # 6d78 <malloc+0x10ea>
    232a:	00004097          	auipc	ra,0x4
    232e:	8a6080e7          	jalr	-1882(ra) # 5bd0 <printf>
    exit(1);
    2332:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2384:	a1850513          	addi	a0,a0,-1512 # 6d98 <malloc+0x110a>
    2388:	00004097          	auipc	ra,0x4
    238c:	848080e7          	jalr	-1976(ra) # 5bd0 <printf>
    exit(1);
    2390:	4505                	li	a0,1
    ...
    23a0:	5ac50513          	addi	a0,a0,1452 # 6948 <malloc+0xcba>
    23a4:	00004097          	auipc	ra,0x4
    23a8:	82c080e7          	jalr	-2004(ra) # 5bd0 <printf>
    exit(1);
    23ac:	4505                	li	a0,1
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243a:	5fa78793          	addi	a5,a5,1530 # 7a30 <malloc+0x1da2>
  ...
  if(ret != -1){
    ...
    247c:	94850513          	addi	a0,a0,-1720 # 6dc0 <malloc+0x1132>
    2480:	00003097          	auipc	ra,0x3
    2484:	750080e7          	jalr	1872(ra) # 5bd0 <printf>
    exit(1);
    2488:	4505                	li	a0,1
    ...
    249a:	3d250513          	addi	a0,a0,978 # 6868 <malloc+0xbda>
    249e:	00003097          	auipc	ra,0x3
    24a2:	732080e7          	jalr	1842(ra) # 5bd0 <printf>
    exit(1);
    24a6:	4505                	li	a0,1
    ...
    24b8:	3d450513          	addi	a0,a0,980 # 6888 <malloc+0xbfa>
    24bc:	00003097          	auipc	ra,0x3
    24c0:	714080e7          	jalr	1812(ra) # 5bd0 <printf>
    exit(1);
    24c4:	4505                	li	a0,1
    ...
    24d8:	3d450513          	addi	a0,a0,980 # 68a8 <malloc+0xc1a>
    24dc:	00003097          	auipc	ra,0x3
    24e0:	6f4080e7          	jalr	1780(ra) # 5bd0 <printf>
    exit(1);
    24e4:	4505                	li	a0,1
    ...
    24f6:	3de50513          	addi	a0,a0,990 # 68d0 <malloc+0xc42>
    24fa:	00003097          	auipc	ra,0x3
    24fe:	6d6080e7          	jalr	1750(ra) # 5bd0 <printf>
    exit(1);
    2502:	4505                	li	a0,1
...
000000000000250c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2542:	8c250513          	addi	a0,a0,-1854 # 5e00 <malloc+0x172>
  ...
  if(n >= 0){
    ...
    2574:	8a850513          	addi	a0,a0,-1880 # 6e18 <malloc+0x118a>
    2578:	00003097          	auipc	ra,0x3
    257c:	658080e7          	jalr	1624(ra) # 5bd0 <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	83e50513          	addi	a0,a0,-1986 # 6dc8 <malloc+0x113a>
    2592:	00003097          	auipc	ra,0x3
    2596:	63e080e7          	jalr	1598(ra) # 5bd0 <printf>
    exit(1);
    259a:	4505                	li	a0,1
    ...
    25a8:	83c50513          	addi	a0,a0,-1988 # 6de0 <malloc+0x1152>
    25ac:	00003097          	auipc	ra,0x3
    25b0:	624080e7          	jalr	1572(ra) # 5bd0 <printf>
    exit(1);
    25b4:	4505                	li	a0,1
    ...
    25c2:	84250513          	addi	a0,a0,-1982 # 6e00 <malloc+0x1172>
    25c6:	00003097          	auipc	ra,0x3
    25ca:	60a080e7          	jalr	1546(ra) # 5bd0 <printf>
    exit(1);
    25ce:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e6:	81e50513          	addi	a0,a0,-2018 # 5e00 <malloc+0x172>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	2ae080e7          	jalr	686(ra) # 5898 <unlink>
  fd = open("README", O_RDONLY);
    25f2:	4581                	li	a1,0
    25f4:	00004517          	auipc	a0,0x4
    25f8:	cb450513          	addi	a0,a0,-844 # 62a8 <malloc+0x61a>
  ...
  if(n >= 0){
    ...
    2622:	82a50513          	addi	a0,a0,-2006 # 6e48 <malloc+0x11ba>
    2626:	00003097          	auipc	ra,0x3
    262a:	5aa080e7          	jalr	1450(ra) # 5bd0 <printf>
    exit(1);
    262e:	4505                	li	a0,1
    ...
    263c:	7c850513          	addi	a0,a0,1992 # 6e00 <malloc+0x1172>
    2640:	00003097          	auipc	ra,0x3
    2644:	590080e7          	jalr	1424(ra) # 5bd0 <printf>
    exit(1);
    2648:	4505                	li	a0,1
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a2:	6705                	lui	a4,0x1
      *b = 99;
    26a4:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1258>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26bc:	7b850513          	addi	a0,a0,1976 # 6e70 <malloc+0x11e2>
    26c0:	00003097          	auipc	ra,0x3
    26c4:	510080e7          	jalr	1296(ra) # 5bd0 <printf>
    exit(1);
    26c8:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    270e:	78650513          	addi	a0,a0,1926 # 6e90 <malloc+0x1202>
    2712:	00003097          	auipc	ra,0x3
    2716:	4be080e7          	jalr	1214(ra) # 5bd0 <printf>
    exit(1);
    271a:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2772:	78250513          	addi	a0,a0,1922 # 6ef0 <malloc+0x1262>
    2776:	00003097          	auipc	ra,0x3
    277a:	45a080e7          	jalr	1114(ra) # 5bd0 <printf>
    exit(1);
    277e:	4505                	li	a0,1
    ...
    2794:	72050513          	addi	a0,a0,1824 # 6eb0 <malloc+0x1222>
    2798:	00003097          	auipc	ra,0x3
    279c:	438080e7          	jalr	1080(ra) # 5bd0 <printf>
      exit(1);
    27a0:	4505                	li	a0,1
    ...
    27b0:	72450513          	addi	a0,a0,1828 # 6ed0 <malloc+0x1242>
    27b4:	00003097          	auipc	ra,0x3
    27b8:	41c080e7          	jalr	1052(ra) # 5bd0 <printf>
    exit(1);
    27bc:	4505                	li	a0,1
...
00000000000027ec <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    284e:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1257>
  a = sbrk(0);
    2852:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b2:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1257>
  ...
  if(c != a){
    ...
    28fa:	61a50513          	addi	a0,a0,1562 # 6f10 <malloc+0x1282>
    28fe:	00003097          	auipc	ra,0x3
    2902:	2d2080e7          	jalr	722(ra) # 5bd0 <printf>
    exit(1);
    2906:	4505                	li	a0,1
    ...
    2916:	64650513          	addi	a0,a0,1606 # 6f58 <malloc+0x12ca>
    291a:	00003097          	auipc	ra,0x3
    291e:	2b6080e7          	jalr	694(ra) # 5bd0 <printf>
    exit(1);
    2922:	4505                	li	a0,1
    ...
    2936:	64650513          	addi	a0,a0,1606 # 6f78 <malloc+0x12ea>
    293a:	00003097          	auipc	ra,0x3
    293e:	296080e7          	jalr	662(ra) # 5bd0 <printf>
    exit(1);
    2942:	4505                	li	a0,1
    ...
    2956:	66650513          	addi	a0,a0,1638 # 6fb8 <malloc+0x132a>
    295a:	00003097          	auipc	ra,0x3
    295e:	276080e7          	jalr	630(ra) # 5bd0 <printf>
    exit(1);
    2962:	4505                	li	a0,1
    ...
    2972:	67a50513          	addi	a0,a0,1658 # 6fe8 <malloc+0x135a>
    2976:	00003097          	auipc	ra,0x3
    297a:	25a080e7          	jalr	602(ra) # 5bd0 <printf>
    exit(1);
    297e:	4505                	li	a0,1
    ...
    2992:	69250513          	addi	a0,a0,1682 # 7020 <malloc+0x1392>
    2996:	00003097          	auipc	ra,0x3
    299a:	23a080e7          	jalr	570(ra) # 5bd0 <printf>
    exit(1);
    299e:	4505                	li	a0,1
...
00000000000029a8 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29cc:	68050513          	addi	a0,a0,1664 # 7048 <malloc+0x13ba>
    29d0:	00003097          	auipc	ra,0x3
    29d4:	eb8080e7          	jalr	-328(ra) # 5888 <open>
    29d8:	84aa                	mv	s1,a0
  unlink("sbrk");
    29da:	00004517          	auipc	a0,0x4
    29de:	66e50513          	addi	a0,a0,1646 # 7048 <malloc+0x13ba>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a32:	62250513          	addi	a0,a0,1570 # 7050 <malloc+0x13c2>
    2a36:	00003097          	auipc	ra,0x3
    2a3a:	19a080e7          	jalr	410(ra) # 5bd0 <printf>
    exit(1);
    2a3e:	4505                	li	a0,1
    ...
    2a4e:	61e50513          	addi	a0,a0,1566 # 7068 <malloc+0x13da>
    2a52:	00003097          	auipc	ra,0x3
    2a56:	17e080e7          	jalr	382(ra) # 5bd0 <printf>
    exit(1);
    2a5a:	4505                	li	a0,1
    ...
    2a6a:	fea50513          	addi	a0,a0,-22 # 6a50 <malloc+0xdc2>
    2a6e:	00003097          	auipc	ra,0x3
    2a72:	162080e7          	jalr	354(ra) # 5bd0 <printf>
    exit(1);
    2a76:	4505                	li	a0,1
...
0000000000002a80 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a94:	5f050513          	addi	a0,a0,1520 # 7080 <malloc+0x13f2>
  ...
  close(fd);
    ...
    2adc:	e8850513          	addi	a0,a0,-376 # 6960 <malloc+0xcd2>
    2ae0:	00003097          	auipc	ra,0x3
    2ae4:	0f0080e7          	jalr	240(ra) # 5bd0 <printf>
    exit(1);
    2ae8:	4505                	li	a0,1
...
0000000000002af2 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2a:	24250513          	addi	a0,a0,578 # 6d68 <malloc+0x10da>
    2b2e:	00003097          	auipc	ra,0x3
    2b32:	0a2080e7          	jalr	162(ra) # 5bd0 <printf>
    exit(1);
    2b36:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b80:	1ec50513          	addi	a0,a0,492 # 6d68 <malloc+0x10da>
    2b84:	00003097          	auipc	ra,0x3
    2b88:	04c080e7          	jalr	76(ra) # 5bd0 <printf>
    exit(1);
    2b8c:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bb8:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x1178>
    ...
    2be0:	18c50513          	addi	a0,a0,396 # 6d68 <malloc+0x10da>
    2be4:	00003097          	auipc	ra,0x3
    2be8:	fec080e7          	jalr	-20(ra) # 5bd0 <printf>
    exit(1);
    2bec:	4505                	li	a0,1
...
0000000000002cdc <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce8:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff125c>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d54:	01850513          	addi	a0,a0,24 # 6d68 <malloc+0x10da>
    2d58:	00003097          	auipc	ra,0x3
    2d5c:	e78080e7          	jalr	-392(ra) # 5bd0 <printf>
      exit(1);
    2d60:	4505                	li	a0,1
    ...
    2da8:	36c50513          	addi	a0,a0,876 # 6110 <malloc+0x482>
    2dac:	faa43c23          	sd	a0,-72(s0)
    2db0:	00003797          	auipc	a5,0x3
    2db4:	3d078793          	addi	a5,a5,976 # 6180 <malloc+0x4f2>
...
0000000000002dd6 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de6:	47650513          	addi	a0,a0,1142 # 7258 <malloc+0x15ca>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df8:	2bc50513          	addi	a0,a0,700 # 70b0 <malloc+0x1422>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e0e:	2fe50513          	addi	a0,a0,766 # 7108 <malloc+0x147a>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e2c:	35850513          	addi	a0,a0,856 # 7180 <malloc+0x14f2>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e48:	3ac50513          	addi	a0,a0,940 # 71f0 <malloc+0x1562>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5a:	3f250513          	addi	a0,a0,1010 # 7248 <malloc+0x15ba>
  ...
  unlink("12345678901234");
    ...
    2ed8:	1b450513          	addi	a0,a0,436 # 7088 <malloc+0x13fa>
    2edc:	00003097          	auipc	ra,0x3
    2ee0:	cf4080e7          	jalr	-780(ra) # 5bd0 <printf>
    exit(1);
    2ee4:	4505                	li	a0,1
    ...
    2ef4:	1e050513          	addi	a0,a0,480 # 70d0 <malloc+0x1442>
    2ef8:	00003097          	auipc	ra,0x3
    2efc:	cd8080e7          	jalr	-808(ra) # 5bd0 <printf>
    exit(1);
    2f00:	4505                	li	a0,1
    ...
    2f10:	22c50513          	addi	a0,a0,556 # 7138 <malloc+0x14aa>
    2f14:	00003097          	auipc	ra,0x3
    2f18:	cbc080e7          	jalr	-836(ra) # 5bd0 <printf>
    exit(1);
    2f1c:	4505                	li	a0,1
    ...
    2f2c:	28850513          	addi	a0,a0,648 # 71b0 <malloc+0x1522>
    2f30:	00003097          	auipc	ra,0x3
    2f34:	ca0080e7          	jalr	-864(ra) # 5bd0 <printf>
    exit(1);
    2f38:	4505                	li	a0,1
    ...
    2f48:	2cc50513          	addi	a0,a0,716 # 7210 <malloc+0x1582>
    2f4c:	00003097          	auipc	ra,0x3
    2f50:	c84080e7          	jalr	-892(ra) # 5bd0 <printf>
    exit(1);
    2f54:	4505                	li	a0,1
    ...
    2f64:	30850513          	addi	a0,a0,776 # 7268 <malloc+0x15da>
    2f68:	00003097          	auipc	ra,0x3
    2f6c:	c68080e7          	jalr	-920(ra) # 5bd0 <printf>
    exit(1);
    2f70:	4505                	li	a0,1
...
0000000000002f7a <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8a:	31a50513          	addi	a0,a0,794 # 72a0 <malloc+0x1612>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f9e:	30650513          	addi	a0,a0,774 # 72a0 <malloc+0x1612>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb2:	33250513          	addi	a0,a0,818 # 72e0 <malloc+0x1652>
  ...
  if(chdir("/") < 0){
    ...
    2fc6:	34e50513          	addi	a0,a0,846 # 7310 <malloc+0x1682>
    ...
    2fe6:	2c650513          	addi	a0,a0,710 # 72a8 <malloc+0x161a>
    2fea:	00003097          	auipc	ra,0x3
    2fee:	be6080e7          	jalr	-1050(ra) # 5bd0 <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    3002:	2c250513          	addi	a0,a0,706 # 72c0 <malloc+0x1632>
    3006:	00003097          	auipc	ra,0x3
    300a:	bca080e7          	jalr	-1078(ra) # 5bd0 <printf>
    exit(1);
    300e:	4505                	li	a0,1
    ...
    301e:	2d650513          	addi	a0,a0,726 # 72f0 <malloc+0x1662>
    3022:	00003097          	auipc	ra,0x3
    3026:	bae080e7          	jalr	-1106(ra) # 5bd0 <printf>
    exit(1);
    302a:	4505                	li	a0,1
    ...
    303a:	2e250513          	addi	a0,a0,738 # 7318 <malloc+0x168a>
    303e:	00003097          	auipc	ra,0x3
    3042:	b92080e7          	jalr	-1134(ra) # 5bd0 <printf>
    exit(1);
    3046:	4505                	li	a0,1
...
0000000000003050 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    306e:	23650513          	addi	a0,a0,566 # 72a0 <malloc+0x1612>
    ...
    3082:	22250513          	addi	a0,a0,546 # 72a0 <malloc+0x1612>
    ...
    3096:	24e50513          	addi	a0,a0,590 # 72e0 <malloc+0x1652>
    ...
    30b6:	89650513          	addi	a0,a0,-1898 # 6948 <malloc+0xcba>
    30ba:	00003097          	auipc	ra,0x3
    30be:	b16080e7          	jalr	-1258(ra) # 5bd0 <printf>
    exit(1);
    30c2:	4505                	li	a0,1
    ...
    30d2:	1da50513          	addi	a0,a0,474 # 72a8 <malloc+0x161a>
    30d6:	00003097          	auipc	ra,0x3
    30da:	afa080e7          	jalr	-1286(ra) # 5bd0 <printf>
      exit(1);
    30de:	4505                	li	a0,1
    ...
    30ee:	24650513          	addi	a0,a0,582 # 7330 <malloc+0x16a2>
    30f2:	00003097          	auipc	ra,0x3
    30f6:	ade080e7          	jalr	-1314(ra) # 5bd0 <printf>
      exit(1);
    30fa:	4505                	li	a0,1
    ...
    310a:	1ea50513          	addi	a0,a0,490 # 72f0 <malloc+0x1662>
    310e:	00003097          	auipc	ra,0x3
    3112:	ac2080e7          	jalr	-1342(ra) # 5bd0 <printf>
      exit(1);
    3116:	4505                	li	a0,1
...
0000000000003138 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3148:	20450513          	addi	a0,a0,516 # 7348 <malloc+0x16ba>
  ...
  if(chdir("dir0") < 0){
    ...
    315c:	1f050513          	addi	a0,a0,496 # 7348 <malloc+0x16ba>
  ...
  if(chdir("..") < 0){
    ...
    3170:	1fc50513          	addi	a0,a0,508 # 7368 <malloc+0x16da>
  ...
  if(unlink("dir0") < 0){
    ...
    3184:	1c850513          	addi	a0,a0,456 # 7348 <malloc+0x16ba>
    ...
    31a4:	10850513          	addi	a0,a0,264 # 72a8 <malloc+0x161a>
    31a8:	00003097          	auipc	ra,0x3
    31ac:	a28080e7          	jalr	-1496(ra) # 5bd0 <printf>
    exit(1);
    31b0:	4505                	li	a0,1
    ...
    31c0:	19450513          	addi	a0,a0,404 # 7350 <malloc+0x16c2>
    31c4:	00003097          	auipc	ra,0x3
    31c8:	a0c080e7          	jalr	-1524(ra) # 5bd0 <printf>
    exit(1);
    31cc:	4505                	li	a0,1
    ...
    31dc:	19850513          	addi	a0,a0,408 # 7370 <malloc+0x16e2>
    31e0:	00003097          	auipc	ra,0x3
    31e4:	9f0080e7          	jalr	-1552(ra) # 5bd0 <printf>
    exit(1);
    31e8:	4505                	li	a0,1
    ...
    31f8:	19450513          	addi	a0,a0,404 # 7388 <malloc+0x16fa>
    31fc:	00003097          	auipc	ra,0x3
    3200:	9d4080e7          	jalr	-1580(ra) # 5bd0 <printf>
    exit(1);
    3204:	4505                	li	a0,1
...
000000000000320e <subdir>:
{
  ...
  unlink("ff");
    ...
    3220:	2b450513          	addi	a0,a0,692 # 74d0 <malloc+0x1842>
    3224:	00002097          	auipc	ra,0x2
    3228:	674080e7          	jalr	1652(ra) # 5898 <unlink>
  if(mkdir("dd") != 0){
    322c:	00004517          	auipc	a0,0x4
    3230:	17450513          	addi	a0,a0,372 # 73a0 <malloc+0x1712>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3248:	17c50513          	addi	a0,a0,380 # 73c0 <malloc+0x1732>
  ...
  write(fd, "ff", 2);
    ...
    3260:	27458593          	addi	a1,a1,628 # 74d0 <malloc+0x1842>
  ...
  if(unlink("dd") >= 0){
    ...
    327a:	12a50513          	addi	a0,a0,298 # 73a0 <malloc+0x1712>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    328e:	18e50513          	addi	a0,a0,398 # 7418 <malloc+0x178a>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a6:	19e50513          	addi	a0,a0,414 # 7440 <malloc+0x17b2>
  ...
  write(fd, "FF", 2);
    ...
    32be:	1b658593          	addi	a1,a1,438 # 7470 <malloc+0x17e2>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32da:	1a250513          	addi	a0,a0,418 # 7478 <malloc+0x17ea>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f2:	aaa58593          	addi	a1,a1,-1366 # bd98 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3308:	a9474703          	lbu	a4,-1388(a4) # bd98 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3322:	1aa58593          	addi	a1,a1,426 # 74c8 <malloc+0x183a>
    3326:	00004517          	auipc	a0,0x4
    332a:	11a50513          	addi	a0,a0,282 # 7440 <malloc+0x17b2>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    333e:	10650513          	addi	a0,a0,262 # 7440 <malloc+0x17b2>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3354:	0f050513          	addi	a0,a0,240 # 7440 <malloc+0x17b2>
  ...
  if(chdir("dd") != 0){
    ...
    3368:	03c50513          	addi	a0,a0,60 # 73a0 <malloc+0x1712>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337c:	1e850513          	addi	a0,a0,488 # 7560 <malloc+0x18d2>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3390:	20450513          	addi	a0,a0,516 # 7590 <malloc+0x1902>
  ...
  if(chdir("./..") != 0){
    ...
    33a4:	22050513          	addi	a0,a0,544 # 75c0 <malloc+0x1932>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33ba:	11250513          	addi	a0,a0,274 # 74c8 <malloc+0x183a>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d2:	9ca58593          	addi	a1,a1,-1590 # bd98 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f4:	05050513          	addi	a0,a0,80 # 7440 <malloc+0x17b2>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340c:	24850513          	addi	a0,a0,584 # 7650 <malloc+0x19c2>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3424:	26050513          	addi	a0,a0,608 # 7680 <malloc+0x19f2>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343c:	f6850513          	addi	a0,a0,-152 # 73a0 <malloc+0x1712>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3452:	f5250513          	addi	a0,a0,-174 # 73a0 <malloc+0x1712>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3468:	f3c50513          	addi	a0,a0,-196 # 73a0 <malloc+0x1712>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    347c:	29858593          	addi	a1,a1,664 # 7710 <malloc+0x1a82>
    3480:	00004517          	auipc	a0,0x4
    3484:	1d050513          	addi	a0,a0,464 # 7650 <malloc+0x19c2>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3498:	27c58593          	addi	a1,a1,636 # 7710 <malloc+0x1a82>
    349c:	00004517          	auipc	a0,0x4
    34a0:	1e450513          	addi	a0,a0,484 # 7680 <malloc+0x19f2>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b4:	01858593          	addi	a1,a1,24 # 74c8 <malloc+0x183a>
    34b8:	00004517          	auipc	a0,0x4
    34bc:	f0850513          	addi	a0,a0,-248 # 73c0 <malloc+0x1732>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d0:	18450513          	addi	a0,a0,388 # 7650 <malloc+0x19c2>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e4:	1a050513          	addi	a0,a0,416 # 7680 <malloc+0x19f2>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f8:	fd450513          	addi	a0,a0,-44 # 74c8 <malloc+0x183a>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350c:	17850513          	addi	a0,a0,376 # 7680 <malloc+0x19f2>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3520:	13450513          	addi	a0,a0,308 # 7650 <malloc+0x19c2>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3534:	e9050513          	addi	a0,a0,-368 # 73c0 <malloc+0x1732>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3548:	31c50513          	addi	a0,a0,796 # 7860 <malloc+0x1bd2>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355c:	f7050513          	addi	a0,a0,-144 # 74c8 <malloc+0x183a>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3570:	e5450513          	addi	a0,a0,-428 # 73c0 <malloc+0x1732>
  ...
  if(unlink("dd") == 0){
    ...
    3584:	e2050513          	addi	a0,a0,-480 # 73a0 <malloc+0x1712>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3598:	33c50513          	addi	a0,a0,828 # 78d0 <malloc+0x1c42>
  ...
  if(unlink("dd") < 0){
    ...
    35ac:	df850513          	addi	a0,a0,-520 # 73a0 <malloc+0x1712>
    ...
    35ce:	dde50513          	addi	a0,a0,-546 # 73a8 <malloc+0x171a>
    35d2:	00002097          	auipc	ra,0x2
    35d6:	5fe080e7          	jalr	1534(ra) # 5bd0 <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35ea:	de250513          	addi	a0,a0,-542 # 73c8 <malloc+0x173a>
    35ee:	00002097          	auipc	ra,0x2
    35f2:	5e2080e7          	jalr	1506(ra) # 5bd0 <printf>
    exit(1);
    35f6:	4505                	li	a0,1
    ...
    3606:	de650513          	addi	a0,a0,-538 # 73e8 <malloc+0x175a>
    360a:	00002097          	auipc	ra,0x2
    360e:	5c6080e7          	jalr	1478(ra) # 5bd0 <printf>
    exit(1);
    3612:	4505                	li	a0,1
    ...
    3622:	e0250513          	addi	a0,a0,-510 # 7420 <malloc+0x1792>
    3626:	00002097          	auipc	ra,0x2
    362a:	5aa080e7          	jalr	1450(ra) # 5bd0 <printf>
    exit(1);
    362e:	4505                	li	a0,1
    ...
    363e:	e1650513          	addi	a0,a0,-490 # 7450 <malloc+0x17c2>
    3642:	00002097          	auipc	ra,0x2
    3646:	58e080e7          	jalr	1422(ra) # 5bd0 <printf>
    exit(1);
    364a:	4505                	li	a0,1
    ...
    365a:	e3250513          	addi	a0,a0,-462 # 7488 <malloc+0x17fa>
    365e:	00002097          	auipc	ra,0x2
    3662:	572080e7          	jalr	1394(ra) # 5bd0 <printf>
    exit(1);
    3666:	4505                	li	a0,1
    ...
    3676:	e3650513          	addi	a0,a0,-458 # 74a8 <malloc+0x181a>
    367a:	00002097          	auipc	ra,0x2
    367e:	556080e7          	jalr	1366(ra) # 5bd0 <printf>
    exit(1);
    3682:	4505                	li	a0,1
    ...
    3692:	e4a50513          	addi	a0,a0,-438 # 74d8 <malloc+0x184a>
    3696:	00002097          	auipc	ra,0x2
    369a:	53a080e7          	jalr	1338(ra) # 5bd0 <printf>
    exit(1);
    369e:	4505                	li	a0,1
    ...
    36ae:	e5650513          	addi	a0,a0,-426 # 7500 <malloc+0x1872>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	51e080e7          	jalr	1310(ra) # 5bd0 <printf>
    exit(1);
    36ba:	4505                	li	a0,1
    ...
    36ca:	e5a50513          	addi	a0,a0,-422 # 7520 <malloc+0x1892>
    36ce:	00002097          	auipc	ra,0x2
    36d2:	502080e7          	jalr	1282(ra) # 5bd0 <printf>
    exit(1);
    36d6:	4505                	li	a0,1
    ...
    36e6:	e6650513          	addi	a0,a0,-410 # 7548 <malloc+0x18ba>
    36ea:	00002097          	auipc	ra,0x2
    36ee:	4e6080e7          	jalr	1254(ra) # 5bd0 <printf>
    exit(1);
    36f2:	4505                	li	a0,1
    ...
    3702:	e7250513          	addi	a0,a0,-398 # 7570 <malloc+0x18e2>
    3706:	00002097          	auipc	ra,0x2
    370a:	4ca080e7          	jalr	1226(ra) # 5bd0 <printf>
    exit(1);
    370e:	4505                	li	a0,1
    ...
    371e:	e8650513          	addi	a0,a0,-378 # 75a0 <malloc+0x1912>
    3722:	00002097          	auipc	ra,0x2
    3726:	4ae080e7          	jalr	1198(ra) # 5bd0 <printf>
    exit(1);
    372a:	4505                	li	a0,1
    ...
    373a:	e9250513          	addi	a0,a0,-366 # 75c8 <malloc+0x193a>
    373e:	00002097          	auipc	ra,0x2
    3742:	492080e7          	jalr	1170(ra) # 5bd0 <printf>
    exit(1);
    3746:	4505                	li	a0,1
    ...
    3756:	e8e50513          	addi	a0,a0,-370 # 75e0 <malloc+0x1952>
    375a:	00002097          	auipc	ra,0x2
    375e:	476080e7          	jalr	1142(ra) # 5bd0 <printf>
    exit(1);
    3762:	4505                	li	a0,1
    ...
    3772:	e9250513          	addi	a0,a0,-366 # 7600 <malloc+0x1972>
    3776:	00002097          	auipc	ra,0x2
    377a:	45a080e7          	jalr	1114(ra) # 5bd0 <printf>
    exit(1);
    377e:	4505                	li	a0,1
    ...
    378e:	e9650513          	addi	a0,a0,-362 # 7620 <malloc+0x1992>
    3792:	00002097          	auipc	ra,0x2
    3796:	43e080e7          	jalr	1086(ra) # 5bd0 <printf>
    exit(1);
    379a:	4505                	li	a0,1
    ...
    37aa:	eba50513          	addi	a0,a0,-326 # 7660 <malloc+0x19d2>
    37ae:	00002097          	auipc	ra,0x2
    37b2:	422080e7          	jalr	1058(ra) # 5bd0 <printf>
    exit(1);
    37b6:	4505                	li	a0,1
    ...
    37c6:	ece50513          	addi	a0,a0,-306 # 7690 <malloc+0x1a02>
    37ca:	00002097          	auipc	ra,0x2
    37ce:	406080e7          	jalr	1030(ra) # 5bd0 <printf>
    exit(1);
    37d2:	4505                	li	a0,1
    ...
    37e2:	ed250513          	addi	a0,a0,-302 # 76b0 <malloc+0x1a22>
    37e6:	00002097          	auipc	ra,0x2
    37ea:	3ea080e7          	jalr	1002(ra) # 5bd0 <printf>
    exit(1);
    37ee:	4505                	li	a0,1
    ...
    37fe:	ed650513          	addi	a0,a0,-298 # 76d0 <malloc+0x1a42>
    3802:	00002097          	auipc	ra,0x2
    3806:	3ce080e7          	jalr	974(ra) # 5bd0 <printf>
    exit(1);
    380a:	4505                	li	a0,1
    ...
    381a:	eda50513          	addi	a0,a0,-294 # 76f0 <malloc+0x1a62>
    381e:	00002097          	auipc	ra,0x2
    3822:	3b2080e7          	jalr	946(ra) # 5bd0 <printf>
    exit(1);
    3826:	4505                	li	a0,1
    ...
    3836:	eee50513          	addi	a0,a0,-274 # 7720 <malloc+0x1a92>
    383a:	00002097          	auipc	ra,0x2
    383e:	396080e7          	jalr	918(ra) # 5bd0 <printf>
    exit(1);
    3842:	4505                	li	a0,1
    ...
    3852:	efa50513          	addi	a0,a0,-262 # 7748 <malloc+0x1aba>
    3856:	00002097          	auipc	ra,0x2
    385a:	37a080e7          	jalr	890(ra) # 5bd0 <printf>
    exit(1);
    385e:	4505                	li	a0,1
    ...
    386e:	f0650513          	addi	a0,a0,-250 # 7770 <malloc+0x1ae2>
    3872:	00002097          	auipc	ra,0x2
    3876:	35e080e7          	jalr	862(ra) # 5bd0 <printf>
    exit(1);
    387a:	4505                	li	a0,1
    ...
    388a:	f1250513          	addi	a0,a0,-238 # 7798 <malloc+0x1b0a>
    388e:	00002097          	auipc	ra,0x2
    3892:	342080e7          	jalr	834(ra) # 5bd0 <printf>
    exit(1);
    3896:	4505                	li	a0,1
    ...
    38a6:	f1650513          	addi	a0,a0,-234 # 77b8 <malloc+0x1b2a>
    38aa:	00002097          	auipc	ra,0x2
    38ae:	326080e7          	jalr	806(ra) # 5bd0 <printf>
    exit(1);
    38b2:	4505                	li	a0,1
    ...
    38c2:	f1a50513          	addi	a0,a0,-230 # 77d8 <malloc+0x1b4a>
    38c6:	00002097          	auipc	ra,0x2
    38ca:	30a080e7          	jalr	778(ra) # 5bd0 <printf>
    exit(1);
    38ce:	4505                	li	a0,1
    ...
    38de:	f2650513          	addi	a0,a0,-218 # 7800 <malloc+0x1b72>
    38e2:	00002097          	auipc	ra,0x2
    38e6:	2ee080e7          	jalr	750(ra) # 5bd0 <printf>
    exit(1);
    38ea:	4505                	li	a0,1
    ...
    38fa:	f2a50513          	addi	a0,a0,-214 # 7820 <malloc+0x1b92>
    38fe:	00002097          	auipc	ra,0x2
    3902:	2d2080e7          	jalr	722(ra) # 5bd0 <printf>
    exit(1);
    3906:	4505                	li	a0,1
    ...
    3916:	f2e50513          	addi	a0,a0,-210 # 7840 <malloc+0x1bb2>
    391a:	00002097          	auipc	ra,0x2
    391e:	2b6080e7          	jalr	694(ra) # 5bd0 <printf>
    exit(1);
    3922:	4505                	li	a0,1
    ...
    3932:	f3a50513          	addi	a0,a0,-198 # 7868 <malloc+0x1bda>
    3936:	00002097          	auipc	ra,0x2
    393a:	29a080e7          	jalr	666(ra) # 5bd0 <printf>
    exit(1);
    393e:	4505                	li	a0,1
    ...
    394e:	bb650513          	addi	a0,a0,-1098 # 7500 <malloc+0x1872>
    3952:	00002097          	auipc	ra,0x2
    3956:	27e080e7          	jalr	638(ra) # 5bd0 <printf>
    exit(1);
    395a:	4505                	li	a0,1
    ...
    396a:	f2250513          	addi	a0,a0,-222 # 7888 <malloc+0x1bfa>
    396e:	00002097          	auipc	ra,0x2
    3972:	262080e7          	jalr	610(ra) # 5bd0 <printf>
    exit(1);
    3976:	4505                	li	a0,1
    ...
    3986:	f2650513          	addi	a0,a0,-218 # 78a8 <malloc+0x1c1a>
    398a:	00002097          	auipc	ra,0x2
    398e:	246080e7          	jalr	582(ra) # 5bd0 <printf>
    exit(1);
    3992:	4505                	li	a0,1
    ...
    39a2:	f3a50513          	addi	a0,a0,-198 # 78d8 <malloc+0x1c4a>
    39a6:	00002097          	auipc	ra,0x2
    39aa:	22a080e7          	jalr	554(ra) # 5bd0 <printf>
    exit(1);
    39ae:	4505                	li	a0,1
    ...
    39be:	f3e50513          	addi	a0,a0,-194 # 78f8 <malloc+0x1c6a>
    39c2:	00002097          	auipc	ra,0x2
    39c6:	20e080e7          	jalr	526(ra) # 5bd0 <printf>
    exit(1);
    39ca:	4505                	li	a0,1
...
00000000000039d4 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e4:	f3050513          	addi	a0,a0,-208 # 7910 <malloc+0x1c82>
  ...
  if(chdir("dots") != 0){
    ...
    39f6:	f1e50513          	addi	a0,a0,-226 # 7910 <malloc+0x1c82>
  ...
  if(unlink(".") == 0){
    ...
    3a08:	da450513          	addi	a0,a0,-604 # 67a8 <malloc+0xb1a>
  ...
  if(unlink("..") == 0){
    ...
    3a1a:	95250513          	addi	a0,a0,-1710 # 7368 <malloc+0x16da>
  ...
  if(chdir("/") != 0){
    ...
    3a2c:	8e850513          	addi	a0,a0,-1816 # 7310 <malloc+0x1682>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a3e:	f3e50513          	addi	a0,a0,-194 # 7978 <malloc+0x1cea>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a50:	f5450513          	addi	a0,a0,-172 # 79a0 <malloc+0x1d12>
  ...
  if(unlink("dots") != 0){
    ...
    3a62:	eb250513          	addi	a0,a0,-334 # 7910 <malloc+0x1c82>
    ...
    3a80:	e9c50513          	addi	a0,a0,-356 # 7918 <malloc+0x1c8a>
    3a84:	00002097          	auipc	ra,0x2
    3a88:	14c080e7          	jalr	332(ra) # 5bd0 <printf>
    exit(1);
    3a8c:	4505                	li	a0,1
    ...
    3a9c:	e9850513          	addi	a0,a0,-360 # 7930 <malloc+0x1ca2>
    3aa0:	00002097          	auipc	ra,0x2
    3aa4:	130080e7          	jalr	304(ra) # 5bd0 <printf>
    exit(1);
    3aa8:	4505                	li	a0,1
    ...
    3ab8:	e9450513          	addi	a0,a0,-364 # 7948 <malloc+0x1cba>
    3abc:	00002097          	auipc	ra,0x2
    3ac0:	114080e7          	jalr	276(ra) # 5bd0 <printf>
    exit(1);
    3ac4:	4505                	li	a0,1
    ...
    3ad4:	e9050513          	addi	a0,a0,-368 # 7960 <malloc+0x1cd2>
    3ad8:	00002097          	auipc	ra,0x2
    3adc:	0f8080e7          	jalr	248(ra) # 5bd0 <printf>
    exit(1);
    3ae0:	4505                	li	a0,1
    ...
    3af0:	82c50513          	addi	a0,a0,-2004 # 7318 <malloc+0x168a>
    3af4:	00002097          	auipc	ra,0x2
    3af8:	0dc080e7          	jalr	220(ra) # 5bd0 <printf>
    exit(1);
    3afc:	4505                	li	a0,1
    ...
    3b0c:	e7850513          	addi	a0,a0,-392 # 7980 <malloc+0x1cf2>
    3b10:	00002097          	auipc	ra,0x2
    3b14:	0c0080e7          	jalr	192(ra) # 5bd0 <printf>
    exit(1);
    3b18:	4505                	li	a0,1
    ...
    3b28:	e8450513          	addi	a0,a0,-380 # 79a8 <malloc+0x1d1a>
    3b2c:	00002097          	auipc	ra,0x2
    3b30:	0a4080e7          	jalr	164(ra) # 5bd0 <printf>
    exit(1);
    3b34:	4505                	li	a0,1
    ...
    3b44:	e8850513          	addi	a0,a0,-376 # 79c8 <malloc+0x1d3a>
    3b48:	00002097          	auipc	ra,0x2
    3b4c:	088080e7          	jalr	136(ra) # 5bd0 <printf>
    exit(1);
    3b50:	4505                	li	a0,1
...
0000000000003b5a <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b70:	54450513          	addi	a0,a0,1348 # 60b0 <malloc+0x422>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b8c:	52850513          	addi	a0,a0,1320 # 60b0 <malloc+0x422>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba0:	e8c50513          	addi	a0,a0,-372 # 7a28 <malloc+0x1d9a>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb8:	e7450513          	addi	a0,a0,-396 # 7a28 <malloc+0x1d9a>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bcc:	e6050513          	addi	a0,a0,-416 # 7a28 <malloc+0x1d9a>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be0:	e4c50513          	addi	a0,a0,-436 # 7a28 <malloc+0x1d9a>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf4:	e3858593          	addi	a1,a1,-456 # 7a28 <malloc+0x1d9a>
    3bf8:	00002517          	auipc	a0,0x2
    3bfc:	6b050513          	addi	a0,a0,1712 # 62a8 <malloc+0x61a>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c10:	4a450513          	addi	a0,a0,1188 # 60b0 <malloc+0x422>
  ...
  fd = open(".", O_RDWR);
    ...
    3c26:	b8650513          	addi	a0,a0,-1146 # 67a8 <malloc+0xb1a>
  ...
  fd = open(".", 0);
    ...
    3c3c:	b7050513          	addi	a0,a0,-1168 # 67a8 <malloc+0xb1a>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c50:	53458593          	addi	a1,a1,1332 # 6180 <malloc+0x4f2>
  ...
  close(fd);
    ...
    3c7c:	d7050513          	addi	a0,a0,-656 # 79e8 <malloc+0x1d5a>
    3c80:	00002097          	auipc	ra,0x2
    3c84:	f50080e7          	jalr	-176(ra) # 5bd0 <printf>
    exit(1);
    3c88:	4505                	li	a0,1
    ...
    3c98:	d7450513          	addi	a0,a0,-652 # 7a08 <malloc+0x1d7a>
    3c9c:	00002097          	auipc	ra,0x2
    3ca0:	f34080e7          	jalr	-204(ra) # 5bd0 <printf>
    exit(1);
    3ca4:	4505                	li	a0,1
    ...
    3cb4:	d8850513          	addi	a0,a0,-632 # 7a38 <malloc+0x1daa>
    3cb8:	00002097          	auipc	ra,0x2
    3cbc:	f18080e7          	jalr	-232(ra) # 5bd0 <printf>
    exit(1);
    3cc0:	4505                	li	a0,1
    ...
    3cd0:	d6c50513          	addi	a0,a0,-660 # 7a38 <malloc+0x1daa>
    3cd4:	00002097          	auipc	ra,0x2
    3cd8:	efc080e7          	jalr	-260(ra) # 5bd0 <printf>
    exit(1);
    3cdc:	4505                	li	a0,1
    ...
    3cec:	d7850513          	addi	a0,a0,-648 # 7a60 <malloc+0x1dd2>
    3cf0:	00002097          	auipc	ra,0x2
    3cf4:	ee0080e7          	jalr	-288(ra) # 5bd0 <printf>
    exit(1);
    3cf8:	4505                	li	a0,1
    ...
    3d08:	d8450513          	addi	a0,a0,-636 # 7a88 <malloc+0x1dfa>
    3d0c:	00002097          	auipc	ra,0x2
    3d10:	ec4080e7          	jalr	-316(ra) # 5bd0 <printf>
    exit(1);
    3d14:	4505                	li	a0,1
    ...
    3d24:	d9050513          	addi	a0,a0,-624 # 7ab0 <malloc+0x1e22>
    3d28:	00002097          	auipc	ra,0x2
    3d2c:	ea8080e7          	jalr	-344(ra) # 5bd0 <printf>
    exit(1);
    3d30:	4505                	li	a0,1
    ...
    3d40:	d9c50513          	addi	a0,a0,-612 # 7ad8 <malloc+0x1e4a>
    3d44:	00002097          	auipc	ra,0x2
    3d48:	e8c080e7          	jalr	-372(ra) # 5bd0 <printf>
    exit(1);
    3d4c:	4505                	li	a0,1
    ...
    3d5c:	da050513          	addi	a0,a0,-608 # 7af8 <malloc+0x1e6a>
    3d60:	00002097          	auipc	ra,0x2
    3d64:	e70080e7          	jalr	-400(ra) # 5bd0 <printf>
    exit(1);
    3d68:	4505                	li	a0,1
    ...
    3d78:	dac50513          	addi	a0,a0,-596 # 7b20 <malloc+0x1e92>
    3d7c:	00002097          	auipc	ra,0x2
    3d80:	e54080e7          	jalr	-428(ra) # 5bd0 <printf>
    exit(1);
    3d84:	4505                	li	a0,1
...
0000000000003d8e <iref>:
{
    ...
    3dac:	d90a0a13          	addi	s4,s4,-624 # 7b38 <malloc+0x1eaa>
    mkdir("");
    3db0:	00004497          	auipc	s1,0x4
    3db4:	89848493          	addi	s1,s1,-1896 # 7648 <malloc+0x19ba>
    link("README", "");
    3db8:	00002a97          	auipc	s5,0x2
    3dbc:	4f0a8a93          	addi	s5,s5,1264 # 62a8 <malloc+0x61a>
    fd = open("xx", O_CREATE);
    3dc0:	00004997          	auipc	s3,0x4
    3dc4:	c7098993          	addi	s3,s3,-912 # 7a30 <malloc+0x1da2>
    3dc8:	a891                	j	3e1c <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dca:	85da                	mv	a1,s6
    3dcc:	00004517          	auipc	a0,0x4
    3dd0:	d7450513          	addi	a0,a0,-652 # 7b40 <malloc+0x1eb2>
    3dd4:	00002097          	auipc	ra,0x2
    3dd8:	dfc080e7          	jalr	-516(ra) # 5bd0 <printf>
      exit(1);
    3ddc:	4505                	li	a0,1
    ...
    3dec:	d7050513          	addi	a0,a0,-656 # 7b58 <malloc+0x1eca>
    3df0:	00002097          	auipc	ra,0x2
    3df4:	de0080e7          	jalr	-544(ra) # 5bd0 <printf>
      exit(1);
    3df8:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e80:	4ec98993          	addi	s3,s3,1260 # 7368 <malloc+0x16da>
    unlink("irefd");
    3e84:	00004917          	auipc	s2,0x4
    3e88:	cb490913          	addi	s2,s2,-844 # 7b38 <malloc+0x1eaa>
    chdir("..");
    3e8c:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea8:	46c50513          	addi	a0,a0,1132 # 7310 <malloc+0x1682>
...
0000000000003ec8 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed8:	c9c50513          	addi	a0,a0,-868 # 7b70 <malloc+0x1ee2>
  ...
  if(pid == 0){
    ...
    3efc:	c7850513          	addi	a0,a0,-904 # 7b70 <malloc+0x1ee2>
    ...
    3f12:	c8250513          	addi	a0,a0,-894 # 7b90 <malloc+0x1f02>
    3f16:	00002097          	auipc	ra,0x2
    3f1a:	cba080e7          	jalr	-838(ra) # 5bd0 <printf>
      exit(1);
    3f1e:	4505                	li	a0,1
    ...
    3f2e:	c4e50513          	addi	a0,a0,-946 # 7b78 <malloc+0x1eea>
    3f32:	00002097          	auipc	ra,0x2
    3f36:	c9e080e7          	jalr	-866(ra) # 5bd0 <printf>
    exit(1);
    3f3a:	4505                	li	a0,1
    ...
    3f4a:	a0250513          	addi	a0,a0,-1534 # 6948 <malloc+0xcba>
    3f4e:	00002097          	auipc	ra,0x2
    3f52:	c82080e7          	jalr	-894(ra) # 5bd0 <printf>
    exit(1);
    3f56:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f78:	bfc50513          	addi	a0,a0,-1028 # 7b70 <malloc+0x1ee2>
    ...
    3f8c:	bb050513          	addi	a0,a0,-1104 # 6b38 <malloc+0xeaa>
    3f90:	00002097          	auipc	ra,0x2
    3f94:	c40080e7          	jalr	-960(ra) # 5bd0 <printf>
    exit(1);
    3f98:	4505                	li	a0,1
...
0000000000003fba <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fca:	bf250513          	addi	a0,a0,-1038 # 7bb8 <malloc+0x1f2a>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff6:	bc650513          	addi	a0,a0,-1082 # 7bb8 <malloc+0x1f2a>
  ...
  sleep(10); // one second
    ...
    402e:	ade50513          	addi	a0,a0,-1314 # 6b08 <malloc+0xe7a>
    4032:	00002097          	auipc	ra,0x2
    4036:	b9e080e7          	jalr	-1122(ra) # 5bd0 <printf>
    exit(1);
    403a:	4505                	li	a0,1
    ...
    4048:	b7448493          	addi	s1,s1,-1164 # 7bb8 <malloc+0x1f2a>
    404c:	4581                	li	a1,0
    404e:	8526                	mv	a0,s1
...
000000000000408a <killstatus>:
{
  ...
  exit(0);
    ...
    40f0:	85c50513          	addi	a0,a0,-1956 # 6948 <malloc+0xcba>
    40f4:	00002097          	auipc	ra,0x2
    40f8:	adc080e7          	jalr	-1316(ra) # 5bd0 <printf>
      exit(1);
    40fc:	4505                	li	a0,1
    ...
    4116:	ab650513          	addi	a0,a0,-1354 # 7bc8 <malloc+0x1f3a>
    411a:	00002097          	auipc	ra,0x2
    411e:	ab6080e7          	jalr	-1354(ra) # 5bd0 <printf>
       exit(1);
    4122:	4505                	li	a0,1
...
000000000000412c <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4156:	9b650513          	addi	a0,a0,-1610 # 6b08 <malloc+0xe7a>
    415a:	00002097          	auipc	ra,0x2
    415e:	a76080e7          	jalr	-1418(ra) # 5bd0 <printf>
    exit(1);
    4162:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4184:	7c850513          	addi	a0,a0,1992 # 6948 <malloc+0xcba>
    4188:	00002097          	auipc	ra,0x2
    418c:	a48080e7          	jalr	-1464(ra) # 5bd0 <printf>
    exit(1);
    4190:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c8:	fbc58593          	addi	a1,a1,-68 # 6180 <malloc+0x4f2>
    ...
    41f2:	75a50513          	addi	a0,a0,1882 # 6948 <malloc+0xcba>
    41f6:	00002097          	auipc	ra,0x2
    41fa:	9da080e7          	jalr	-1574(ra) # 5bd0 <printf>
     exit(1);
    41fe:	4505                	li	a0,1
    ...
    420e:	9de50513          	addi	a0,a0,-1570 # 7be8 <malloc+0x1f5a>
    4212:	00002097          	auipc	ra,0x2
    4216:	9be080e7          	jalr	-1602(ra) # 5bd0 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    422e:	b6e58593          	addi	a1,a1,-1170 # bd98 <buf>
    ...
    424a:	9ba50513          	addi	a0,a0,-1606 # 7c00 <malloc+0x1f72>
    424e:	00002097          	auipc	ra,0x2
    4252:	982080e7          	jalr	-1662(ra) # 5bd0 <printf>
}
  ...
  printf("kill... ");
    ...
    4276:	9a650513          	addi	a0,a0,-1626 # 7c18 <malloc+0x1f8a>
    427a:	00002097          	auipc	ra,0x2
    427e:	956080e7          	jalr	-1706(ra) # 5bd0 <printf>
  kill(pid1);
    4282:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    42a4:	98850513          	addi	a0,a0,-1656 # 7c28 <malloc+0x1f9a>
    42a8:	00002097          	auipc	ra,0x2
    42ac:	928080e7          	jalr	-1752(ra) # 5bd0 <printf>
  wait(0);
    42b0:	4501                	li	a0,0
...
00000000000042d0 <reparent>:
{
  ...
  exit(0);
    ...
    4324:	62850513          	addi	a0,a0,1576 # 6948 <malloc+0xcba>
    4328:	00002097          	auipc	ra,0x2
    432c:	8a8080e7          	jalr	-1880(ra) # 5bd0 <printf>
      exit(1);
    4330:	4505                	li	a0,1
    ...
    4340:	79450513          	addi	a0,a0,1940 # 6ad0 <malloc+0xe42>
    4344:	00002097          	auipc	ra,0x2
    4348:	88c080e7          	jalr	-1908(ra) # 5bd0 <printf>
        exit(1);
    434c:	4505                	li	a0,1
...
0000000000004380 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b6:	69e50513          	addi	a0,a0,1694 # 6a50 <malloc+0xdc2>
    43ba:	00002097          	auipc	ra,0x2
    43be:	816080e7          	jalr	-2026(ra) # 5bd0 <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43ea:	d9a58593          	addi	a1,a1,-614 # 6180 <malloc+0x4f2>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44ae:	78e50513          	addi	a0,a0,1934 # 7c38 <malloc+0x1faa>
    44b2:	00001097          	auipc	ra,0x1
    44b6:	71e080e7          	jalr	1822(ra) # 5bd0 <printf>
    exit(1);
    44ba:	4505                	li	a0,1
    ...
    44ca:	48250513          	addi	a0,a0,1154 # 6948 <malloc+0xcba>
    44ce:	00001097          	auipc	ra,0x1
    44d2:	702080e7          	jalr	1794(ra) # 5bd0 <printf>
    exit(1);
    44d6:	4505                	li	a0,1
    ...
    4500:	6705                	lui	a4,0x1
      n += *(a+i);
    4502:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1258>
    ...
    4516:	74650513          	addi	a0,a0,1862 # 7c58 <malloc+0x1fca>
    451a:	00001097          	auipc	ra,0x1
    451e:	6b6080e7          	jalr	1718(ra) # 5bd0 <printf>
    exit(1);
    4522:	4505                	li	a0,1
...
0000000000004536 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4580:	712080e7          	jalr	1810(ra) # 5c8e <malloc>
    ...
    45ba:	6d250513          	addi	a0,a0,1746 # 7c88 <malloc+0x1ffa>
    45be:	00001097          	auipc	ra,0x1
    45c2:	612080e7          	jalr	1554(ra) # 5bd0 <printf>
      exit(1);
    45c6:	4505                	li	a0,1
...
00000000000045da <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4670:	63c50513          	addi	a0,a0,1596 # 7ca8 <malloc+0x201a>
    4674:	00001097          	auipc	ra,0x1
    4678:	55c080e7          	jalr	1372(ra) # 5bd0 <printf>
    exit(1);
    467c:	4505                	li	a0,1
    ...
    468c:	64850513          	addi	a0,a0,1608 # 7cd0 <malloc+0x2042>
    4690:	00001097          	auipc	ra,0x1
    4694:	540080e7          	jalr	1344(ra) # 5bd0 <printf>
      exit(1);
    4698:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d0:	85450513          	addi	a0,a0,-1964 # 5f20 <malloc+0x292>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4710:	5e450513          	addi	a0,a0,1508 # 7cf0 <malloc+0x2062>
    4714:	00001097          	auipc	ra,0x1
    4718:	4bc080e7          	jalr	1212(ra) # 5bd0 <printf>
    exit(1);
    471c:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    474c:	7d850513          	addi	a0,a0,2008 # 5f20 <malloc+0x292>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4772:	5aa50513          	addi	a0,a0,1450 # 7d18 <malloc+0x208a>
    4776:	00001097          	auipc	ra,0x1
    477a:	45a080e7          	jalr	1114(ra) # 5bd0 <printf>
    exit(1);
    477e:	4505                	li	a0,1
...
0000000000004792 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b8:	5c478793          	addi	a5,a5,1476 # 5d78 <malloc+0xea>
    47bc:	f6f43823          	sd	a5,-144(s0)
    47c0:	00001797          	auipc	a5,0x1
    47c4:	5c078793          	addi	a5,a5,1472 # 5d80 <malloc+0xf2>
    47c8:	f6f43c23          	sd	a5,-136(s0)
    47cc:	00001797          	auipc	a5,0x1
    47d0:	5bc78793          	addi	a5,a5,1468 # 5d88 <malloc+0xfa>
    47d4:	f8f43023          	sd	a5,-128(s0)
    47d8:	00001797          	auipc	a5,0x1
    47dc:	5b878793          	addi	a5,a5,1464 # 5d90 <malloc+0x102>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4834:	568a0a13          	addi	s4,s4,1384 # bd98 <buf>
    4838:	00007a97          	auipc	s5,0x7
    483c:	561a8a93          	addi	s5,s5,1377 # bd99 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4854:	51850513          	addi	a0,a0,1304 # 6d68 <malloc+0x10da>
    4858:	00001097          	auipc	ra,0x1
    485c:	378080e7          	jalr	888(ra) # 5bd0 <printf>
      exit(1);
    4860:	4505                	li	a0,1
    ...
    48d0:	46450513          	addi	a0,a0,1124 # 7d30 <malloc+0x20a2>
    48d4:	00001097          	auipc	ra,0x1
    48d8:	2fc080e7          	jalr	764(ra) # 5bd0 <printf>
        exit(1);
    48dc:	4505                	li	a0,1
    ...
    48ea:	45a50513          	addi	a0,a0,1114 # 7d40 <malloc+0x20b2>
    48ee:	00001097          	auipc	ra,0x1
    48f2:	2e2080e7          	jalr	738(ra) # 5bd0 <printf>
          exit(1);
    48f6:	4505                	li	a0,1
    ...
    4912:	44a50513          	addi	a0,a0,1098 # 7d58 <malloc+0x20ca>
    4916:	00001097          	auipc	ra,0x1
    491a:	2ba080e7          	jalr	698(ra) # 5bd0 <printf>
          exit(1);
    491e:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a0:	3cc50513          	addi	a0,a0,972 # 7d68 <malloc+0x20da>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	22c080e7          	jalr	556(ra) # 5bd0 <printf>
      exit(1);
    49ac:	4505                	li	a0,1
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a02:	382b8b93          	addi	s7,s7,898 # 7d80 <malloc+0x20f2>
  for(i = 0; i < N; i++){
    ...
    4a44:	34850513          	addi	a0,a0,840 # 7d88 <malloc+0x20fa>
    4a48:	00001097          	auipc	ra,0x1
    4a4c:	188080e7          	jalr	392(ra) # 5bd0 <printf>
        exit(1);
    4a50:	4505                	li	a0,1
    ...
    4a62:	32250513          	addi	a0,a0,802 # 7d80 <malloc+0x20f2>
  ...
  fd = open(".", 0);
    ...
    4a9a:	d1250513          	addi	a0,a0,-750 # 67a8 <malloc+0xb1a>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b10:	29c50513          	addi	a0,a0,668 # 7da8 <malloc+0x211a>
    4b14:	00001097          	auipc	ra,0x1
    4b18:	0bc080e7          	jalr	188(ra) # 5bd0 <printf>
        exit(1);
    4b1c:	4505                	li	a0,1
    ...
    4b30:	29c50513          	addi	a0,a0,668 # 7dc8 <malloc+0x213a>
    4b34:	00001097          	auipc	ra,0x1
    4b38:	09c080e7          	jalr	156(ra) # 5bd0 <printf>
        exit(1);
    4b3c:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b68:	28c50513          	addi	a0,a0,652 # 7df0 <malloc+0x2162>
    4b6c:	00001097          	auipc	ra,0x1
    4b70:	064080e7          	jalr	100(ra) # 5bd0 <printf>
    exit(1);
    4b74:	4505                	li	a0,1
    ...
    4b84:	dc850513          	addi	a0,a0,-568 # 6948 <malloc+0xcba>
    4b88:	00001097          	auipc	ra,0x1
    4b8c:	048080e7          	jalr	72(ra) # 5bd0 <printf>
      exit(1);
    4b90:	4505                	li	a0,1
...
0000000000004d2e <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db6:	07650513          	addi	a0,a0,118 # 7e28 <malloc+0x219a>
  ...
  for(i = 0; ; i++){
    ...
    4e1a:	02250513          	addi	a0,a0,34 # 7e38 <malloc+0x21aa>
    4e1e:	00001097          	auipc	ra,0x1
    4e22:	db2080e7          	jalr	-590(ra) # 5bd0 <printf>
    exit(1);
    4e26:	4505                	li	a0,1
    ...
    4e36:	02650513          	addi	a0,a0,38 # 7e58 <malloc+0x21ca>
    4e3a:	00001097          	auipc	ra,0x1
    4e3e:	d96080e7          	jalr	-618(ra) # 5bd0 <printf>
      exit(1);
    4e42:	4505                	li	a0,1
    ...
    4e52:	02a50513          	addi	a0,a0,42 # 7e78 <malloc+0x21ea>
    4e56:	00001097          	auipc	ra,0x1
    4e5a:	d7a080e7          	jalr	-646(ra) # 5bd0 <printf>
    exit(1);
    4e5e:	4505                	li	a0,1
    ...
    4e6e:	02e50513          	addi	a0,a0,46 # 7e98 <malloc+0x220a>
    4e72:	00001097          	auipc	ra,0x1
    4e76:	d5e080e7          	jalr	-674(ra) # 5bd0 <printf>
      exit(1);
    4e7a:	4505                	li	a0,1
    ...
    4e8a:	03250513          	addi	a0,a0,50 # 7eb8 <malloc+0x222a>
    4e8e:	00001097          	auipc	ra,0x1
    4e92:	d42080e7          	jalr	-702(ra) # 5bd0 <printf>
      exit(1);
    4e96:	4505                	li	a0,1
    ...
    4ea6:	02e50513          	addi	a0,a0,46 # 7ed0 <malloc+0x2242>
    4eaa:	00001097          	auipc	ra,0x1
    4eae:	d26080e7          	jalr	-730(ra) # 5bd0 <printf>
      exit(1);
    4eb2:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed4:	f5850513          	addi	a0,a0,-168 # 7e28 <malloc+0x219a>
    ...
    4ef8:	ffc50513          	addi	a0,a0,-4 # 7ef0 <malloc+0x2262>
    4efc:	00001097          	auipc	ra,0x1
    4f00:	cd4080e7          	jalr	-812(ra) # 5bd0 <printf>
    exit(1);
    4f04:	4505                	li	a0,1
...
0000000000004f0e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f30:	fe450513          	addi	a0,a0,-28 # 7f10 <malloc+0x2282>
    4f34:	00001097          	auipc	ra,0x1
    4f38:	c9c080e7          	jalr	-868(ra) # 5bd0 <printf>
  for(nfiles = 0; ; nfiles++){
    4f3c:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f50:	fd4c8c93          	addi	s9,s9,-44 # 7f20 <malloc+0x2292>
    int total = 0;
    4f54:	4d81                	li	s11,0
    ...
    4fa8:	c2c080e7          	jalr	-980(ra) # 5bd0 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fca:	f6a50513          	addi	a0,a0,-150 # 7f30 <malloc+0x22a2>
    4fce:	00001097          	auipc	ra,0x1
    4fd2:	c02080e7          	jalr	-1022(ra) # 5bd0 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5040:	f1450513          	addi	a0,a0,-236 # 7f50 <malloc+0x22c2>
    5044:	00001097          	auipc	ra,0x1
    5048:	b8c080e7          	jalr	-1140(ra) # 5bd0 <printf>
}
    ...
    5090:	eb450513          	addi	a0,a0,-332 # 7f40 <malloc+0x22b2>
    5094:	00001097          	auipc	ra,0x1
    5098:	b3c080e7          	jalr	-1220(ra) # 5bd0 <printf>
    close(fd);
    509c:	854a                	mv	a0,s2
...
00000000000050ae <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5122:	e4a50513          	addi	a0,a0,-438 # 7f68 <malloc+0x22da>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513a:	04a58593          	addi	a1,a1,74 # 6180 <malloc+0x4f2>
    ...
    5150:	e3c50513          	addi	a0,a0,-452 # 7f88 <malloc+0x22fa>
    5154:	00001097          	auipc	ra,0x1
    5158:	a7c080e7          	jalr	-1412(ra) # 5bd0 <printf>
    exit(1);
    515c:	4505                	li	a0,1
    ...
    516a:	e0a50513          	addi	a0,a0,-502 # 7f70 <malloc+0x22e2>
    516e:	00001097          	auipc	ra,0x1
    5172:	a62080e7          	jalr	-1438(ra) # 5bd0 <printf>
      exit(1);
    5176:	4505                	li	a0,1
    ...
    5184:	df050513          	addi	a0,a0,-528 # 7f70 <malloc+0x22e2>
    5188:	00001097          	auipc	ra,0x1
    518c:	a48080e7          	jalr	-1464(ra) # 5bd0 <printf>
    exit(1);
    5190:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a8:	dc450513          	addi	a0,a0,-572 # 7f68 <malloc+0x22da>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fe:	f8698993          	addi	s3,s3,-122 # 6180 <malloc+0x4f2>
      uint64 a = (uint64) sbrk(4096);
    ...
    5230:	dac50513          	addi	a0,a0,-596 # 7fd8 <malloc+0x234a>
    5234:	00001097          	auipc	ra,0x1
    5238:	99c080e7          	jalr	-1636(ra) # 5bd0 <printf>
        exit(1);
    523c:	4505                	li	a0,1
    ...
    524a:	d5250513          	addi	a0,a0,-686 # 7f98 <malloc+0x230a>
    524e:	00001097          	auipc	ra,0x1
    5252:	982080e7          	jalr	-1662(ra) # 5bd0 <printf>
    exit(1);
    5256:	4505                	li	a0,1
    ...
    5264:	d5850513          	addi	a0,a0,-680 # 7fb8 <malloc+0x232a>
    5268:	00001097          	auipc	ra,0x1
    526c:	968080e7          	jalr	-1688(ra) # 5bd0 <printf>
    exit(1);
    5270:	4505                	li	a0,1
  ...
  while(1){
    ...
    52b2:	d4a50513          	addi	a0,a0,-694 # 7ff8 <malloc+0x236a>
    52b6:	00001097          	auipc	ra,0x1
    52ba:	91a080e7          	jalr	-1766(ra) # 5bd0 <printf>
      exit(1);
    52be:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5302:	d1a50513          	addi	a0,a0,-742 # 8018 <malloc+0x238a>
    5306:	00001097          	auipc	ra,0x1
    530a:	8ca080e7          	jalr	-1846(ra) # 5bd0 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5332:	d1250513          	addi	a0,a0,-750 # 8040 <malloc+0x23b2>
    5336:	00001097          	auipc	ra,0x1
    533a:	89a080e7          	jalr	-1894(ra) # 5bd0 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5356:	cd650513          	addi	a0,a0,-810 # 8028 <malloc+0x239a>
    535a:	00001097          	auipc	ra,0x1
    535e:	876080e7          	jalr	-1930(ra) # 5bd0 <printf>
    exit(1);
    5362:	4505                	li	a0,1
    ...
    537e:	cce50513          	addi	a0,a0,-818 # 8048 <malloc+0x23ba>
    5382:	00001097          	auipc	ra,0x1
    5386:	84e080e7          	jalr	-1970(ra) # 5bd0 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c8:	da478793          	addi	a5,a5,-604 # 8168 <malloc+0x24da>
    53cc:	bd040713          	addi	a4,s0,-1072
    53d0:	00003317          	auipc	t1,0x3
    53d4:	18830313          	addi	t1,t1,392 # 8558 <digits>
  ...
  printf("usertests starting\n");
    ...
    5408:	cfc50513          	addi	a0,a0,-772 # 8100 <malloc+0x2472>
    540c:	00000097          	auipc	ra,0x0
    5410:	7c4080e7          	jalr	1988(ra) # 5bd0 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5440:	c7c50513          	addi	a0,a0,-900 # 80b8 <malloc+0x242a>
    5444:	00000097          	auipc	ra,0x0
    5448:	78c080e7          	jalr	1932(ra) # 5bd0 <printf>
    exit(1);
    544c:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    545c:	bf858593          	addi	a1,a1,-1032 # 8050 <malloc+0x23c2>
    ...
    5472:	cca58593          	addi	a1,a1,-822 # 8138 <malloc+0x24aa>
    ...
    5496:	bc650513          	addi	a0,a0,-1082 # 8058 <malloc+0x23ca>
    549a:	00000097          	auipc	ra,0x0
    549e:	736080e7          	jalr	1846(ra) # 5bd0 <printf>
    exit(1);
    54a2:	4505                	li	a0,1
    ...
    54c0:	714080e7          	jalr	1812(ra) # 5bd0 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5502:	ba250513          	addi	a0,a0,-1118 # 80a0 <malloc+0x2412>
    5506:	00000097          	auipc	ra,0x0
    550a:	6ca080e7          	jalr	1738(ra) # 5bd0 <printf>
    exit(1);
    550e:	4505                	li	a0,1
    ...
    551c:	bd050513          	addi	a0,a0,-1072 # 80e8 <malloc+0x245a>
    5520:	00000097          	auipc	ra,0x0
    5524:	6b0080e7          	jalr	1712(ra) # 5bd0 <printf>
    exit(0);
    5528:	4501                	li	a0,0
    ...
    5538:	69c080e7          	jalr	1692(ra) # 5bd0 <printf>
        if(continuous != 2)
    ...
    557a:	bf278793          	addi	a5,a5,-1038 # 8168 <malloc+0x24da>
    557e:	bd040713          	addi	a4,s0,-1072
    5582:	00003317          	auipc	t1,0x3
    5586:	fd630313          	addi	t1,t1,-42 # 8558 <digits>
    ...
    55ba:	b6250513          	addi	a0,a0,-1182 # 8118 <malloc+0x248a>
    55be:	00000097          	auipc	ra,0x0
    55c2:	612080e7          	jalr	1554(ra) # 5bd0 <printf>
        printf("SOME TESTS FAILED\n");
    55c6:	00003a97          	auipc	s5,0x3
    55ca:	adaa8a93          	addi	s5,s5,-1318 # 80a0 <malloc+0x2412>
        if(continuous != 2)
    55ce:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d0:	00003b17          	auipc	s6,0x3
    55d4:	ab0b0b13          	addi	s6,s6,-1360 # 8080 <malloc+0x23f2>
...
putc(int fd, char c)
{
    58f8:	1101                	addi	sp,sp,-32
    58fa:	ec06                	sd	ra,24(sp)
    58fc:	e822                	sd	s0,16(sp)
    58fe:	1000                	addi	s0,sp,32
    5900:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5904:	4605                	li	a2,1
    5906:	fef40593          	addi	a1,s0,-17
    590a:	00000097          	auipc	ra,0x0
    590e:	f5e080e7          	jalr	-162(ra) # 5868 <write>
}
    5912:	60e2                	ld	ra,24(sp)
    5914:	6442                	ld	s0,16(sp)
    5916:	6105                	addi	sp,sp,32
    5918:	8082                	ret

000000000000591a <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    591a:	7139                	addi	sp,sp,-64
    591c:	fc06                	sd	ra,56(sp)
    591e:	f822                	sd	s0,48(sp)
    5920:	f426                	sd	s1,40(sp)
    5922:	f04a                	sd	s2,32(sp)
    5924:	ec4e                	sd	s3,24(sp)
    5926:	0080                	addi	s0,sp,64
    5928:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    592a:	c299                	beqz	a3,5930 <printint+0x16>
    592c:	0805c863          	bltz	a1,59bc <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5930:	2581                	sext.w	a1,a1
  neg = 0;
    5932:	4881                	li	a7,0
    5934:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    593a:	2601                	sext.w	a2,a2
    593c:	00003517          	auipc	a0,0x3
    5940:	c1c50513          	addi	a0,a0,-996 # 8558 <digits>
    5944:	883a                	mv	a6,a4
    5946:	2705                	addiw	a4,a4,1
    5948:	02c5f7bb          	remuw	a5,a1,a2
    594c:	1782                	slli	a5,a5,0x20
    594e:	9381                	srli	a5,a5,0x20
    5950:	97aa                	add	a5,a5,a0
    5952:	0007c783          	lbu	a5,0(a5)
    5956:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    595a:	0005879b          	sext.w	a5,a1
    595e:	02c5d5bb          	divuw	a1,a1,a2
    5962:	0685                	addi	a3,a3,1
    5964:	fec7f0e3          	bgeu	a5,a2,5944 <printint+0x2a>
  if(neg)
    5968:	00088b63          	beqz	a7,597e <printint+0x64>
    buf[i++] = '-';
    596c:	fd040793          	addi	a5,s0,-48
    5970:	973e                	add	a4,a4,a5
    5972:	02d00793          	li	a5,45
    5976:	fef70823          	sb	a5,-16(a4)
    597a:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    597e:	02e05863          	blez	a4,59ae <printint+0x94>
    5982:	fc040793          	addi	a5,s0,-64
    5986:	00e78933          	add	s2,a5,a4
    598a:	fff78993          	addi	s3,a5,-1
    598e:	99ba                	add	s3,s3,a4
    5990:	377d                	addiw	a4,a4,-1
    5992:	1702                	slli	a4,a4,0x20
    5994:	9301                	srli	a4,a4,0x20
    5996:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    599a:	fff94583          	lbu	a1,-1(s2)
    599e:	8526                	mv	a0,s1
    59a0:	00000097          	auipc	ra,0x0
    59a4:	f58080e7          	jalr	-168(ra) # 58f8 <putc>
  while(--i >= 0)
    59a8:	197d                	addi	s2,s2,-1
    59aa:	ff3918e3          	bne	s2,s3,599a <printint+0x80>
}
    59ae:	70e2                	ld	ra,56(sp)
    59b0:	7442                	ld	s0,48(sp)
    59b2:	74a2                	ld	s1,40(sp)
    59b4:	7902                	ld	s2,32(sp)
    59b6:	69e2                	ld	s3,24(sp)
    59b8:	6121                	addi	sp,sp,64
    59ba:	8082                	ret
    x = -xx;
    59bc:	40b005bb          	negw	a1,a1
    neg = 1;
    59c0:	4885                	li	a7,1
    x = -xx;
    59c2:	bf8d                	j	5934 <printint+0x1a>

00000000000059c4 <vprintf>:
}
...
{
    59c4:	7119                	addi	sp,sp,-128
    59c6:	fc86                	sd	ra,120(sp)
    59c8:	f8a2                	sd	s0,112(sp)
    59ca:	f4a6                	sd	s1,104(sp)
    59cc:	f0ca                	sd	s2,96(sp)
    59ce:	ecce                	sd	s3,88(sp)
    59d0:	e8d2                	sd	s4,80(sp)
    59d2:	e4d6                	sd	s5,72(sp)
    59d4:	e0da                	sd	s6,64(sp)
    59d6:	fc5e                	sd	s7,56(sp)
    59d8:	f862                	sd	s8,48(sp)
    59da:	f466                	sd	s9,40(sp)
    59dc:	f06a                	sd	s10,32(sp)
    59de:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    59e2:	0005c903          	lbu	s2,0(a1)
    59e6:	18090f63          	beqz	s2,5b84 <vprintf+0x1c0>
    59ea:	8aaa                	mv	s5,a0
    59ec:	8b32                	mv	s6,a2
    59ee:	00158493          	addi	s1,a1,1
  state = 0;
    59f2:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    59f4:	02500a13          	li	s4,37
      if(c == 'd'){
    59f8:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    59fc:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5a00:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5a04:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a08:	00003b97          	auipc	s7,0x3
    5a0c:	b50b8b93          	addi	s7,s7,-1200 # 8558 <digits>
    5a10:	a839                	j	5a2e <vprintf+0x6a>
        putc(fd, c);
    5a12:	85ca                	mv	a1,s2
    5a14:	8556                	mv	a0,s5
    5a16:	00000097          	auipc	ra,0x0
    5a1a:	ee2080e7          	jalr	-286(ra) # 58f8 <putc>
    5a1e:	a019                	j	5a24 <vprintf+0x60>
    } else if(state == '%'){
    5a20:	01498f63          	beq	s3,s4,5a3e <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5a24:	0485                	addi	s1,s1,1
    5a26:	fff4c903          	lbu	s2,-1(s1)
    5a2a:	14090d63          	beqz	s2,5b84 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5a2e:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5a32:	fe0997e3          	bnez	s3,5a20 <vprintf+0x5c>
      if(c == '%'){
    5a36:	fd479ee3          	bne	a5,s4,5a12 <vprintf+0x4e>
        state = '%';
    5a3a:	89be                	mv	s3,a5
    5a3c:	b7e5                	j	5a24 <vprintf+0x60>
      if(c == 'd'){
    5a3e:	05878063          	beq	a5,s8,5a7e <vprintf+0xba>
      } else if(c == 'l') {
    5a42:	05978c63          	beq	a5,s9,5a9a <vprintf+0xd6>
      } else if(c == 'x') {
    5a46:	07a78863          	beq	a5,s10,5ab6 <vprintf+0xf2>
      } else if(c == 'p') {
    5a4a:	09b78463          	beq	a5,s11,5ad2 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5a4e:	07300713          	li	a4,115
    5a52:	0ce78663          	beq	a5,a4,5b1e <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5a56:	06300713          	li	a4,99
    5a5a:	0ee78e63          	beq	a5,a4,5b56 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5a5e:	11478863          	beq	a5,s4,5b6e <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5a6a:	e92080e7          	jalr	-366(ra) # 58f8 <putc>
        putc(fd, c);
    5a6e:	85ca                	mv	a1,s2
    5a70:	8556                	mv	a0,s5
    5a72:	00000097          	auipc	ra,0x0
    5a76:	e86080e7          	jalr	-378(ra) # 58f8 <putc>
      }
      state = 0;
    5a7a:	4981                	li	s3,0
    5a7c:	b765                	j	5a24 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5a90:	e8e080e7          	jalr	-370(ra) # 591a <printint>
    5a94:	8b4a                	mv	s6,s2
      state = 0;
    5a96:	4981                	li	s3,0
    5a98:	b771                	j	5a24 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5aac:	e72080e7          	jalr	-398(ra) # 591a <printint>
    5ab0:	8b4a                	mv	s6,s2
      state = 0;
    5ab2:	4981                	li	s3,0
    5ab4:	bf85                	j	5a24 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    5ac8:	e56080e7          	jalr	-426(ra) # 591a <printint>
    5acc:	8b4a                	mv	s6,s2
      state = 0;
    5ace:	4981                	li	s3,0
    5ad0:	bf91                	j	5a24 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
  ...
  putc(fd, '0');
    ...
    5ae8:	e14080e7          	jalr	-492(ra) # 58f8 <putc>
  putc(fd, 'x');
    5aec:	85ea                	mv	a1,s10
    5aee:	8556                	mv	a0,s5
    5af0:	00000097          	auipc	ra,0x0
    5af4:	e08080e7          	jalr	-504(ra) # 58f8 <putc>
    5af8:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5afa:	03c9d793          	srli	a5,s3,0x3c
    5afe:	97de                	add	a5,a5,s7
    5b00:	0007c583          	lbu	a1,0(a5)
    5b04:	8556                	mv	a0,s5
    5b06:	00000097          	auipc	ra,0x0
    5b0a:	df2080e7          	jalr	-526(ra) # 58f8 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b0e:	0992                	slli	s3,s3,0x4
    5b10:	397d                	addiw	s2,s2,-1
    5b12:	fe0914e3          	bnez	s2,5afa <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5b16:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b1a:	4981                	li	s3,0
    5b1c:	b721                	j	5a24 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b1e:	008b0993          	addi	s3,s6,8
    5b22:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5b26:	02090163          	beqz	s2,5b48 <vprintf+0x184>
        while(*s != 0){
    5b2a:	00094583          	lbu	a1,0(s2)
    5b2e:	c9a1                	beqz	a1,5b7e <vprintf+0x1ba>
          putc(fd, *s);
    5b30:	8556                	mv	a0,s5
    5b32:	00000097          	auipc	ra,0x0
    5b36:	dc6080e7          	jalr	-570(ra) # 58f8 <putc>
          s++;
    5b3a:	0905                	addi	s2,s2,1
        while(*s != 0){
    5b3c:	00094583          	lbu	a1,0(s2)
    5b40:	f9e5                	bnez	a1,5b30 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5b42:	8b4e                	mv	s6,s3
      state = 0;
    5b44:	4981                	li	s3,0
    5b46:	bdf9                	j	5a24 <vprintf+0x60>
          s = "(null)";
    5b48:	00002917          	auipc	s2,0x2
    5b4c:	5f890913          	addi	s2,s2,1528 # 8140 <malloc+0x24b2>
        while(*s != 0){
    5b50:	02800593          	li	a1,40
    5b54:	bff1                	j	5b30 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5b56:	008b0913          	addi	s2,s6,8
    5b5a:	000b4583          	lbu	a1,0(s6)
    5b5e:	8556                	mv	a0,s5
    5b60:	00000097          	auipc	ra,0x0
    5b64:	d98080e7          	jalr	-616(ra) # 58f8 <putc>
    5b68:	8b4a                	mv	s6,s2
      state = 0;
    5b6a:	4981                	li	s3,0
    5b6c:	bd65                	j	5a24 <vprintf+0x60>
        putc(fd, c);
    5b6e:	85d2                	mv	a1,s4
    5b70:	8556                	mv	a0,s5
    5b72:	00000097          	auipc	ra,0x0
    5b76:	d86080e7          	jalr	-634(ra) # 58f8 <putc>
      state = 0;
    5b7a:	4981                	li	s3,0
    5b7c:	b565                	j	5a24 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b7e:	8b4e                	mv	s6,s3
      state = 0;
    5b80:	4981                	li	s3,0
    5b82:	b54d                	j	5a24 <vprintf+0x60>
    }
  }
}
    5b84:	70e6                	ld	ra,120(sp)
    5b86:	7446                	ld	s0,112(sp)
    5b88:	74a6                	ld	s1,104(sp)
    5b8a:	7906                	ld	s2,96(sp)
    5b8c:	69e6                	ld	s3,88(sp)
    5b8e:	6a46                	ld	s4,80(sp)
    5b90:	6aa6                	ld	s5,72(sp)
    5b92:	6b06                	ld	s6,64(sp)
    5b94:	7be2                	ld	s7,56(sp)
    5b96:	7c42                	ld	s8,48(sp)
    5b98:	7ca2                	ld	s9,40(sp)
    5b9a:	7d02                	ld	s10,32(sp)
    5b9c:	6de2                	ld	s11,24(sp)
    5b9e:	6109                	addi	sp,sp,128
    5ba0:	8082                	ret

0000000000005ba2 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5ba2:	715d                	addi	sp,sp,-80
    5ba4:	ec06                	sd	ra,24(sp)
    5ba6:	e822                	sd	s0,16(sp)
    5ba8:	1000                	addi	s0,sp,32
    5baa:	e010                	sd	a2,0(s0)
    5bac:	e414                	sd	a3,8(s0)
    5bae:	e818                	sd	a4,16(s0)
    5bb0:	ec1c                	sd	a5,24(s0)
    5bb2:	03043023          	sd	a6,32(s0)
    5bb6:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5bba:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5bbe:	8622                	mv	a2,s0
    5bc0:	00000097          	auipc	ra,0x0
    5bc4:	e04080e7          	jalr	-508(ra) # 59c4 <vprintf>
}
    5bc8:	60e2                	ld	ra,24(sp)
    5bca:	6442                	ld	s0,16(sp)
    5bcc:	6161                	addi	sp,sp,80
    5bce:	8082                	ret

0000000000005bd0 <printf>:

void
printf(const char *fmt, ...)
{
    5bd0:	711d                	addi	sp,sp,-96
    5bd2:	ec06                	sd	ra,24(sp)
    5bd4:	e822                	sd	s0,16(sp)
    5bd6:	1000                	addi	s0,sp,32
    5bd8:	e40c                	sd	a1,8(s0)
    5bda:	e810                	sd	a2,16(s0)
    5bdc:	ec14                	sd	a3,24(s0)
    5bde:	f018                	sd	a4,32(s0)
    5be0:	f41c                	sd	a5,40(s0)
    5be2:	03043823          	sd	a6,48(s0)
    5be6:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5bea:	00840613          	addi	a2,s0,8
    5bee:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5bf2:	85aa                	mv	a1,a0
    5bf4:	4505                	li	a0,1
    5bf6:	00000097          	auipc	ra,0x0
    5bfa:	dce080e7          	jalr	-562(ra) # 59c4 <vprintf>
}
    5bfe:	60e2                	ld	ra,24(sp)
    5c00:	6442                	ld	s0,16(sp)
    5c02:	6125                	addi	sp,sp,96
    5c04:	8082                	ret

0000000000005c06 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    5c0c:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c10:	00003797          	auipc	a5,0x3
    5c14:	9687b783          	ld	a5,-1688(a5) # 8578 <freep>
    5c18:	a805                	j	5c48 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c1a:	4618                	lw	a4,8(a2)
    5c1c:	9db9                	addw	a1,a1,a4
    5c1e:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c22:	6398                	ld	a4,0(a5)
    5c24:	6318                	ld	a4,0(a4)
    5c26:	fee53823          	sd	a4,-16(a0)
    5c2a:	a091                	j	5c6e <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c2c:	ff852703          	lw	a4,-8(a0)
    5c30:	9e39                	addw	a2,a2,a4
    5c32:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5c34:	ff053703          	ld	a4,-16(a0)
    5c38:	e398                	sd	a4,0(a5)
    5c3a:	a099                	j	5c80 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c3c:	6398                	ld	a4,0(a5)
    5c3e:	00e7e463          	bltu	a5,a4,5c46 <free+0x40>
    5c42:	00e6ea63          	bltu	a3,a4,5c56 <free+0x50>
{
    5c46:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c48:	fed7fae3          	bgeu	a5,a3,5c3c <free+0x36>
    5c4c:	6398                	ld	a4,0(a5)
    5c4e:	00e6e463          	bltu	a3,a4,5c56 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c52:	fee7eae3          	bltu	a5,a4,5c46 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5c56:	ff852583          	lw	a1,-8(a0)
    5c5a:	6390                	ld	a2,0(a5)
    5c5c:	02059713          	slli	a4,a1,0x20
    5c60:	9301                	srli	a4,a4,0x20
    5c62:	0712                	slli	a4,a4,0x4
    5c64:	9736                	add	a4,a4,a3
    5c66:	fae60ae3          	beq	a2,a4,5c1a <free+0x14>
    bp->s.ptr = p->s.ptr;
    5c6a:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c6e:	4790                	lw	a2,8(a5)
    5c70:	02061713          	slli	a4,a2,0x20
    5c74:	9301                	srli	a4,a4,0x20
    5c76:	0712                	slli	a4,a4,0x4
    5c78:	973e                	add	a4,a4,a5
    5c7a:	fae689e3          	beq	a3,a4,5c2c <free+0x26>
  } else
    p->s.ptr = bp;
    5c7e:	e394                	sd	a3,0(a5)
  freep = p;
    5c80:	00003717          	auipc	a4,0x3
    5c84:	8ef73c23          	sd	a5,-1800(a4) # 8578 <freep>
}
    5c88:	6422                	ld	s0,8(sp)
    5c8a:	0141                	addi	sp,sp,16
    5c8c:	8082                	ret

0000000000005c8e <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    5c9a:	e852                	sd	s4,16(sp)
    5c9c:	e456                	sd	s5,8(sp)
    5c9e:	e05a                	sd	s6,0(sp)
    5ca0:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5ca2:	02051493          	slli	s1,a0,0x20
    5ca6:	9081                	srli	s1,s1,0x20
    5ca8:	04bd                	addi	s1,s1,15
    5caa:	8091                	srli	s1,s1,0x4
    5cac:	0014899b          	addiw	s3,s1,1
    5cb0:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5cb2:	00003517          	auipc	a0,0x3
    5cb6:	8c653503          	ld	a0,-1850(a0) # 8578 <freep>
    5cba:	c515                	beqz	a0,5ce6 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5cbc:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5cbe:	4798                	lw	a4,8(a5)
    5cc0:	02977f63          	bgeu	a4,s1,5cfe <malloc+0x70>
    5cc4:	8a4e                	mv	s4,s3
    5cc6:	0009871b          	sext.w	a4,s3
    5cca:	6685                	lui	a3,0x1
    5ccc:	00d77363          	bgeu	a4,a3,5cd2 <malloc+0x44>
    5cd0:	6a05                	lui	s4,0x1
    5cd2:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cd6:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5cda:	00003917          	auipc	s2,0x3
    5cde:	89e90913          	addi	s2,s2,-1890 # 8578 <freep>
  if(p == (char*)-1)
    5ce2:	5afd                	li	s5,-1
    5ce4:	a88d                	j	5d56 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5ce6:	00009797          	auipc	a5,0x9
    5cea:	0b278793          	addi	a5,a5,178 # ed98 <base>
    5cee:	00003717          	auipc	a4,0x3
    5cf2:	88f73523          	sd	a5,-1910(a4) # 8578 <freep>
    5cf6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5cf8:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5cfc:	b7e1                	j	5cc4 <malloc+0x36>
      if(p->s.size == nunits)
    5cfe:	02e48b63          	beq	s1,a4,5d34 <malloc+0xa6>
        p->s.size -= nunits;
    5d02:	4137073b          	subw	a4,a4,s3
    5d06:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d08:	1702                	slli	a4,a4,0x20
    5d0a:	9301                	srli	a4,a4,0x20
    5d0c:	0712                	slli	a4,a4,0x4
    5d0e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d10:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d14:	00003717          	auipc	a4,0x3
    5d18:	86a73223          	sd	a0,-1948(a4) # 8578 <freep>
      return (void*)(p + 1);
    ...
    5d38:	bff1                	j	5d14 <malloc+0x86>
  hp->s.size = nu;
    5d3a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d3e:	0541                	addi	a0,a0,16
    5d40:	00000097          	auipc	ra,0x0
    5d44:	ec6080e7          	jalr	-314(ra) # 5c06 <free>
  return freep;
    5d48:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d4c:	d971                	beqz	a0,5d20 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d4e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d50:	4798                	lw	a4,8(a5)
    5d52:	fa9776e3          	bgeu	a4,s1,5cfe <malloc+0x70>
    if(p == freep)
    5d56:	00093703          	ld	a4,0(s2)
    5d5a:	853e                	mv	a0,a5
    5d5c:	fef719e3          	bne	a4,a5,5d4e <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5d60:	8552                	mv	a0,s4
    5d62:	00000097          	auipc	ra,0x0
    5d66:	b6e080e7          	jalr	-1170(ra) # 58d0 <sbrk>
  if(p == (char*)-1)
    5d6a:	fd5518e3          	bne	a0,s5,5d3a <malloc+0xac>
        return 0;
    5d6e:	4501                	li	a0,0
    5d70:	bf45                	j	5d20 <malloc+0x92>
